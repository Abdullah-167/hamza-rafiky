...
const Cards = () => {
    ...
    const cards = [
        {
          icon: <TbPinnedFilled />,
          heading: t("servicesAgency_card1Heading"),
          para:t("servicesAgency_card1Para"),
          bgColor: "rgba(122,105,230,0.3)",
          color: "#7a69e6",
        },
        {
          icon: <FaArrowsAlt />,
          heading: t("servicesAgency_card2Heading"),
          para:t("servicesAgency_card2Para"),
          bgColor: "rgba(250,94,93,0.3)",
          color: "#fa5e5d",
        },
        {
          icon: <HiSpeakerWave />,
          heading: t("servicesAgency_card3Heading"),
          para:t("servicesAgency_card3Para"),
          bgColor: "#D5F0C6",
          color: "#76CE44",
        }
      ];
