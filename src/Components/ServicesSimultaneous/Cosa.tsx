...
const Cosa = () => {
  ...
  const data = [
    {
      url: "u6wyZwyTVoA",
      btnTitle: t("servicesSimultaneousInterpretation_cosaBtnTitle"),
      heading: t("servicesSimultaneousInterpretation_cosaTitle"),
      para: t("servicesSimultaneousInterpretation_cosaPara"),
    },
  ];
