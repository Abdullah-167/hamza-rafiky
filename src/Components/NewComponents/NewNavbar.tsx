    ...
    <nav>
      <div className="flex justify-between items-center container z-[1000] relative">
            ...
            <div className=" grid grid-cols-3 gap-5 relative">
              <div className="bg-[#8624e1] bg-opacity-10 px-5 pt-[44px]">
                {fistImage.map((item, index) => (
                  <div key={index}>
                    <h2 className="text-2xl pb-6 font-semibold">
                      {item.mainHeading}
                    </h2>
                    <div className="pb-10">
                      {item.innerData.map((newItem, idx) => {
                        return (
                          <div
                            className="flex gap-6 items-center max-w-[300px] font-normal pb-5 cursor-pointer"
                            key={idx}
                          >
                            <Image
                              src={newItem.img}
                ...
                {text.map((item, index) => (
                  <div key={index}>
                    ...
                    {item.innerData.map((newItem, idx) => {
                      return (
                        <div
                          className="flex gap-2 items-center max-w-[360px] font-normal pb-5 cursor-pointer"
                          key={idx}
                        >
                          <span className="text-base">{newItem.text}</span>
                        </div>
                  ...
                  <div key={index}>
                    ...
                    <div className="pb-10">
                      {item.innerData.map((newItem, idx) => {
                        return (
                          <div
                            className="flex gap-2 items-center max-w-[300px] font-normal pb-5 cursor-pointer"
                            key={idx}
                          >
                            <span className="text-base">{newItem.text}</span>
                          </div>
                ...
                {secDrop2Two.map((item, index) => (
                  <div key={index} className="">
                    ...
                    {item.innerData.map((newItem, idx) => {
                      return (
                        <div
                          className="flex gap-2 items-center max-w-[360px] font-normal  cursor-pointer pb-4"
                          key={idx}
                        >
                          <span className="text-base">{newItem.text}</span>
                        </div>
                  ...
                  <div key={index}>
                    ...
                    <div className="pb-16">
                      {item.innerData.map((newItem, idx) => {
                        return (
                          <div
                            className="flex gap-2 items-center max-w-[360px] font-normal pb-4 cursor-pointer"
                            key={idx}
                          >
                            <span className="text-base">{newItem.text}</span>
                          </div>
        ...
        <div className="flex xl:hidden">
          <span className="text-4xl cursor-pointer " onClick={handlenavbar}>
            {handleNav ? <RxCross1 /> : <BiMenu />}
          </span>
        </div>
      </div>
      <div
        className={` absolute z-[500] py-8 transition-all top-[105px] duration-700 bg-white max-w-[400px] sm:max-w-[400px] h-full  px-10 text-black w-full ${
          handleNav
            ? " -translate-x-[20px] opacity-100 "
      ...
      >
        {handleNav && (
          ...
          >
            ...
            >
              <div className="flex flex-col justify-between gap-6 container relative">
                <div>
                  {fistImage.map((item, index) => (
                    <div key={index}>
                      ...
                      <span className=" absolute bottom-4 cursor-pointer">
                        {item.btn}
                      </span>
                    </div>
                  ))}
                ...
                <div>
                  {text.map((item, index) => (
                    <div key={index}>
                      <h2 className="text-2xl pb-1 sm:pb-6 font-semibold">
                        {item.mainHeading}
                      </h2>
                      {item.innerData.map((newItem, idx) => {
                        return (
            ...
            <span className="text-sm px-3 py-3 flex justify-center items-center mt-10 rounded-full border-2 border-gray-600 mb-3">
              Get A Demo
            </span>
            <span className=" text-sm px-3 py-4 flex justify-center items-center rounded-full bg-[#8624e1] text-white">
              Start bFree Trail
            </span>
          </div>
        )}
