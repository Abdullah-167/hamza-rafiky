...
const Cosa = () => {
  ...
  const data = [
    {
      url: "u6wyZwyTVoA",
      subHeading1: t("caseStudyVolksvagen_subHeading1"),
      firstColorHeadingLaChallenge: t('firstColorHeadingLaChallengeRedBull'),
      secondColorHeadingLaChallenge: t('secondColorHeadingVolksVegan'),
      para1: t("caseStudyVolksvagen_para1"),
      para2: t("caseStudyVolksvagen_para2"),
      para3: t("caseStudyVolksvagen_para3"),
      para7: t("caseStudyVolksvagen_para7"),
      para4: t("caseStudyVolksvagen_para4"),
      para5: t("caseStudyVolksvagen_para5"),
      para6: t("caseStudyVolksvagen_para6"),
    },
  ];
