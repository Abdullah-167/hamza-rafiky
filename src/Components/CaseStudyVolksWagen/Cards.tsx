    ...
    const cards = [
        {
            ...
            heading: t('volksVeganFirstHeading'),
            para: t('volksVeganFirstPara'),
            bgColor: 'rgba(122,105,230,0.3)',
            color: '#7a69e6'
        },
        {
            icon: <AiOutlineDesktop />,
            heading: t('volksVeganSecHeading'),
            para: t('volksVeganSecPara'),
            bgColor: 'rgba(250,94,93,0.3)',
            color: '#fa5e5d'
        },
        {
            icon: <BsCoin />,
            heading: t('volksVeganThirdHeading'),
            para: t('volksVeganThirdPara'),
            bgColor: 'rgba(249,141,94,0.3)',
            color: '#f98d5e'
        },
        {
            icon: <BsStar />,
            heading: t('volksVeganFourthHeading'),
            para: t('volksVeganFourthPara'),
    ...
    return (
        <div className='bg-[#FFFFFF]'>
            <div className='container'>
                <h2 className=' text-[35px] sm:text-[45px] text-[#333333] font-bold text-center mb-12'>LA Challenge</h2>
                ...
                <div className='py-20 max-w-[900px] mx-auto'>
                    <strong className="text-[26px] text-center sm:text-[50px] text-[#7830f6] font-bold sm:min-w-[600px] pb-5">
                        {t('volksVageHeading')}
                    </strong>
                    <p className="text-sm text-[#666666] font-medium leading-6 pb-2">
                        {t('volksVagepara')}
                    </p>
                    <p className="text-sm text-[#666666] font-medium leading-6 pb-2">
                        {t('volksVagepara2')}
                ...
                <div className='flex gap-3 items-center py-10'>
                    <Image className='w-16 h-16' src={'/wordpress.png'} alt={''} width={200} height={200} />
