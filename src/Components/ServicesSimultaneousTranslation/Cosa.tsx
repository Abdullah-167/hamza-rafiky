...
const Cosa = () => {
  ...
  const data = [
    {
      url: "u6wyZwyTVoA",
      btnTitle: t("servicesSimultaneousTranslation_cosaBtnTitle"),
      heading: t("servicesSimultaneousTranslation_cosaTitle"),
      para: t("servicesSimultaneousTranslation_cosaPara"),
    },
  ];
