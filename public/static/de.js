export const de = {
  ...
  partnerZoneIneerSec: "Übersetzungsagenturen",
  interpretio: "Dolmetschen in allen Sprachen",
  interpretioFrist: "Dolmetschen in britischem Englisch",
  interpretioSec: "Dolmetschen in amerikanischem Englisch",
  interpretioThird: "Dolmetschen auf Französisch",
  interpretioFour: "Dolmetschen auf Spanisch",
  interpretioFive: "Dolmetschen auf Chinesisch",
  ...
  serviziInnerOne: "Rafiky-Integration mit Microsoft Teams",
  serviziInnerTwo: "Rafiky-Dolmetschen in Gebärdensprache",
  serviziInnerThree: "Fern-Dolmetscher",
  serviziInnerFour: "Rafiky XP",

  chiSiamo: "Wer wir sind",
  comeFuziona: "Wie es funktioniert",
  casiDuso: "Anwendungsfälle",
  ...
  pages: "Seiten",
  footerPageOne: "Wer wir sind",
  footerPageTwo: "Wie es funktioniert",
  footerPageThree: "Anwendungsfälle",
  footerPageFour: "Kontaktiere uns",
  footerPageFive: "Umbuchungs-, Stornierungs- und Rückerstattungsrichtlinie",
  ...
  thankYou: "Danke !",
  thankYouDesc:
    "Danke für dein Interesse! Überprüfen Sie Ihre E-Mails auf einen Link zum Leitfaden.",
  homeBtn: "Home",
  // Blog
  blogh1Title: "Möchten Sie mehr über die Welt des Dolmetschens erfahren?",
  // Home Hero
  home_HeroTitle: `Simultandolmetschen aus der Ferne`,
  home_HeroSubTitle: `Ferndolmetschen `,
  home_HeroDescription: `Warum umständliche Hardware verwenden, wenn die Technologie es uns ermöglicht, mit nur wenigen Klicks eine überlegene Qualität zu erzielen? Probieren Sie die Rafiky-Software für Ferndolmetschen aus. Sie benötigen lediglich einen Laptop und ein Smartphone (oder Tablet).    `,
  ...
  chooseRafiky_Firstcard_para: `Unsere Auswahl an Ferndolmetschern wird Ihre Gäste beeindrucken!`,
  chooseRafiky_Seccard_Heading: `INCREASED FLEXIBILITY`,
  chooseRafiky_Seccard_para: `Wir können Ihrem Publikum jederzeit und überall bis zu 200 Sprachen anbieten!`,
  chooseRafiky_Thirdcard_Heading: `BEQUEMLICHKEIT`,
  ChooseRafiky_Thirdcard_para: `Reduzieren Sie Ihre Kosten um +50 % ohne Kompromisse bei der Qualität. Vergessen Sie Ausrüstung und Reisen!`,
  chooseRafiky_Forthcard_Heading: `TOP QUALITÄT`,
  chooseRafiky_Forthcard_para: `Nur kristallklares Audio- und High-Definition-Video-Streaming. Haben Sie so etwas schon einmal gesehen?`,
  chooseRafiky_Fifthcard_Heading: `BARRIEREFREIHEIT`,
  chooseRafiky_Fifthcard_para: `Von überall aus war das Einloggen noch nie so einfach. Die Mailänder Dolmetscheragentur, von der Sie nicht wussten, dass Sie sie brauchen!`,
  chooseRafiky_Sixthcard_Heading: `GLOBALE UNTERSTÜTZUNG h24GLOBALE UNTERSTÜTZUNG h24`,
  chooseRafiky_Sixthcard_para: `Unser Team ist unter allen Umständen immer verfügbar. Wir wählen nur die besten Ferndolmetscher für Sie aus!`,
  chooseRafiky_Seventhcard_Heading: `SUPER BENUTZERFREUNDLICH!`,
  chooseRafiky_Seventhcard_para: `Download our application and see the success of your events and meetings.`,
  chooseRafiky_Eightcard_Heading: `DAS BESTE VOM BESTEN`,
  chooseRafiky_Eightcard_para: `Die besten Dolmetscher der Welt stehen Ihnen auch aus der Ferne in jeder Situation zur Verfügung!`,
  //Future Remote
  futureRemote_Heading: `Die Zukunft des Ferndolmetschens!`,
  futureRemote_para: `Über die Plattform von Rafiky stehen Ihnen die besten Darsteller der Welt zur Verfügung, wo immer Sie wollen. Auf Wiedersehen Ausgaben für die Miete`,
  futureRemote_Btn: `SCHNELLE UND KOSTENLOSE KOSTENVORANSCHLAG`,
  //REMOTE INTERPRETING
  REMOTEINTERPRETING_Heading: `GLEICHZEITIGES FERNDOLMETSCHEN`,
  REMOTEINTERPRETING_para: `Wir verbinden Benutzer überall auf der Welt! Rafiky ist ein mobiles System, das Audio-Streaming-Hardware für Live-Events vollständig ersetzt. Mit nur einem Computer und einer Verbindung kann jede Art von Audio über unsere mobile Anwendung auf die Telefone oder Tablets der Zuhörer gestreamt werden. Ein Ferndolmetscher kümmert sich um die korrekte Kommunikation. Rafikys Remote-Simultandolmetschlösungen sind für Veranstaltungen jeder Art und Art konzipiert.`,
  REMOTEINTERPRETING_Btn: `FINDE MEHR HERAUS`,
  //New Reality
  newReality_Heading: `Tauchen Sie mit uns in eine neue Realität ein!`,
  newReality_para: `Warum komplexe Hardware verwenden, wenn Sie sterben gleiche Ergebnisse erzielen can, Indem Sie einfach eine Anwendung herunterladen? Rafiky ist ein mobiles Fernübersetzungssystem, das Audio-Streaming-Hardware für Live-Events vollständig ersetzt. Mit nur einem Computer und einer Internetverbindung kann jede Art von Audio über eine mobile Anwendung auf die Telefone oder Tablets der Zuhörer gestreamt werden. Konfigurieren Sie einfach die Plattform und geben Sie den Teilnehmern Zugangsdaten, um eine internationale Veranstaltung von überall auf der Welt mit kristallklarem Audio und HD-Video-Streaming zu genießen. Dank Remote-Simultandolmetschen werden Remote-Teilnehmer und die besten Remote-Dolmetscher in Echtzeit verbunden: Die Veranstaltung ist für alle Benutzer zugänglich, wo immer sie sind und in jeder gewünschten Sprache.`,
  newReality_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Home Ready
  homeReady_Heading: `BEREIT?`,
  homeReady_para: `Fordern Sie jetzt ein Angebot für Ihre nächste Veranstaltung an!`,
  homeReady_Btn: `FORDERN SIE JETZT EIN ANGEBOT AN`,
  //Home Form
  homeForm_heading: `Eine Demo anfordern`,
  homeForm_name: `Name*`,
  homeForm_email: `Email*`,
  homeForm_company: `Name der Firma*`,
  homeForm_telephone: `Telefonnummer*`,
  homeForm_firstevent: `Veranstaltungsdaten*`,
  homeForm_secevent: `Veranstaltungszeiten*`,
  homeForm_Btn: `ANGEBOTE ERHALTEN`,
  //Services Hero
  services_HeroTitle: `Simultandolmetschen aus der Ferne: die beste Lösung`,
  services_Heropara: `Mit Rafiky können Sie jeden Ort in einen Konferenzraum verwandeln! Wir kombinieren die Leistungsfähigkeit der Cloud-Technologie mit modernen Geräten, um die Technik der Simultandolmetschen aus der Ferne zu erleichtern!`,
  services_HeroBtn: `KONTAKTIERE UNS`,
  //Services 360degree
  ...
  serviceschooseRafiky_SecTitle: `VERWENDEN SIE DIE BESTE TECHNOLOGIE IN DER WELT DES FERNGESTEUERTEN GLEICHZEITIGEN DOLMETSCHENS`,
  ...
  teamsIntegration_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  ...
  teamsIntegration_Seccard_para: `Verwenden Sie weiterhin Ihre bevorzugte Plattform, indem Sie den Ferndolmetschdienst mit Rafiky integrieren. Keine Übergangskosten!`,
  teamsIntegration_Thirdcard_Heading: `0 SWITCHING COSTS`,
  teamsIntegration_Thirdcard_para: `Verwenden Sie weiterhin Ihre bevorzugte Plattform, indem Sie den Ferndolmetschdienst mit Rafiky integrieren. Keine Übergangskosten!`,
  teamsIntegration_Forthcard_Heading: `SAVINGS`,
  teamsIntegration_Forthcard_para: `Verwenden Sie weiterhin Ihre bevorzugte Plattform, indem Sie den Ferndolmetschdienst mit Rafiky integrieren. Keine Übergangskosten!`,
  teamsIntegration_Fifthcard_Heading: `PRE-EVENT-TEST`,
  teamsIntegration_Fifthcard_para: `Verwenden Sie weiterhin Ihre bevorzugte Plattform, indem Sie den Ferndolmetschdienst mit Rafiky integrieren. Keine Übergangskosten!`,
  teamsIntegration_Sixthcard_Heading: `TECHNISCHER SUPPORT`,
  teamsIntegration_Sixthcard_para: `Verwenden Sie weiterhin Ihre bevorzugte Plattform, indem Sie den Ferndolmetschdienst mit Rafiky integrieren. Keine Übergangskosten!`,
  ...
  //Pronto
  pronto_Heading: `FERTIG?`,
  pronto_para: `VERÄNDERE DIE WELT MIT EINEM KLICK!`,
  ...
  servicesLanguageinterpretation_Heading: `Dolmetschen der Gebärdensprache in Rafiky`,
  servicesLanguageinterpretation_para: `Angesichts der Bedeutung des Gebärdensprachdolmetschens war die Bereitstellung von Remote-Gebärdensprachdolmetschern Teil von Rafikys Mission. Gebärdensprachdolmetschen ist ein exklusiver Service, den wir Unternehmen für die Organisation von Veranstaltungen und Konferenzen anbieten. Der fernverbundene Gebärdensprachdolmetscher formuliert die ursprüngliche Nachricht über akustisch-verbale und visuell-gestische Kanäle neu und richtet sie an den gehörlosen Gesprächspartner in der Zielsprache. Der Dolmetscher muss daher auch die Gebärdensprache, die gesprochene Sprache und die an der Kommunikation beteiligten Kulturen kennen, um eine optimale und performante Übersetzungs- und Dolmetschleistung in Gebärdensprache zu gewährleisten.`,
  servicesLanguageinterpretation_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  servicesLanguageinterpretatio_Firstcountingtest: `Sprachen`,
  servicesLanguageinterpretatio_Seccountingtest: `Online-Veranstaltungen`,
  servicesLanguageinterpretatio_Thirdcountingtest: `Professionelle Dolmetscher`,
  servicesLanguageinterpretatio_FirstcardTitle: `EINFACHE LÖSUNG`,
  servicesLanguageinterpretatio_Firstcardpara: `Durch die Vereinfachung der Zeitplanung und des Betriebsmanagements können Sie an jeder Art von Veranstaltung teilnehmen, ohne Ihr Zuhause oder Ihren Arbeitsplatz zu verlassen. `,
  servicesLanguageinterpretatio_SeccardTitle: `0 SWITCHING COSTS `,
  servicesLanguageinterpretatio_Seccardpara: `Verwenden Sie weiterhin Ihre bevorzugte Plattform, indem Sie den Ferndolmetschdienst mit Rafiky integrieren. Keine Übergangskosten!`,
  servicesLanguageinterpretatio_ThirdcardTitle: `ERSPARNISSE`,
  servicesLanguageinterpretatio_Thirdcardpara: `Der Wegfall der Kosten, die normalerweise mit traditionellem Dolmetschen verbunden sind (von der Miete der Übersetzungsausrüstung bis zu den Reise- und Unterbringungskosten der Dolmetscher), trägt dazu bei, Ihre Kosten um +80 % zu senken, ohne die Qualität der Dienstleistung zu beeinträchtigen.`,
  servicesLanguageinterpretatio_ForthcardTitle: `PRE-EVENT-TEST`,
  servicesLanguageinterpretatio_Forthcardpara: `Um die beste User Experience zu garantieren, führen Referenten und Teilnehmer kurz vor Veranstaltungsbeginn einen kostenlosen Test zur Nutzung von Rafiky integriert mit der gewünschten Plattform durch.`,
  servicesLanguageinterpretatio_FifthcardTitle: `TECHNISCHER SUPPORT`,
  servicesLanguageinterpretatio_Fifthcardpara: `Unsere Techniker stehen Ihnen während der gesamten Dauer der Veranstaltung mit spezialisierter technischer Unterstützung zur Seite.`,
  servicesLanguageinterpretatio_SixcardTitle: `QUALIFIZIERTE DOLMETSCHER`,
  servicesLanguageinterpretatio_Sixcardpara: `Erfahrene und erfahrene Dolmetscher mit integrierten Systemen zu Ihren Diensten. Professionalität Erfahrung Systemwissen`,
  servicesLanguageinterpretatio_SevencardTitle: `RISIKOREDUZIERUNG`,
  servicesLanguageinterpretatio_Sevencardpara: `Bei Problemen oder Fehlfunktionen der Drittplattform können die Veranstaltungsteilnehmer jederzeit vollständig über unsere App zu Rafiky „umziehen“.`,
  servicesLanguageinterpretatio_EightcardTitle: `EINZIGARTIGES ERLEBNIS  `,
  servicesLanguageinterpretatio_Eightcardpara: `'Bei Problemen oder Fehlfunktionen der Drittplattform können die Veranstaltungsteilnehmer jederzeit vollständig über unsere App zu Rafiky „umziehen“.`,
  //Services Why Sign
  servicesWhysign_Heading: `Warum ist Gebärdensprachdolmetschen wichtig?`,
  servicesWhysign_para: `Der Dolmetscherdienst für Gebärdensprache ermöglicht es gehörlosen Menschen, in einem sozialen Kontext zu kommunizieren und zu interagieren. Rafiky ist fest davon überzeugt, welches Potenzial dieser Service bietet. Ziel ist es, die Zugänglichkeit für alle in der Kommunikation zu erweitern, anstatt sie einzuschränken. Gebärdensprache ist die einzige Sprache, die Gehörlose kennen und beherrschen. Diese Sprache zu beherrschen bedeutet, sich mit ihnen verständigen zu können, ohne dass sie sich in irgendeiner Weise in einer interlinguistischen und sozialen Interaktion ausgeschlossen fühlen. Bei der Organisation einer internationalen Veranstaltung ist es wahrscheinlich, dass Gehörlose unter den Teilnehmern sein können. Um zu verhindern, dass sie sich ausgeschlossen oder vernachlässigt fühlen, verlassen Sie sich auf professionelle Gebärdensprachdolmetscherdienste. Die Gebärdensprache ist mit ihren Regeln und ihrer grammatikalischen Syntax eine vollwertige Sprache. Heute als Grundlage der Kultur der Kategorien Gehörloser oder Menschen mit Verständnisschwierigkeiten anerkannt, hat sie tatsächlich eine sehr alte Geschichte. Sokrates beschreibt in dem Werk „Cratilo“ die Spontaneität in der gestischen und nonverbalen Kommunikation, die unter Umständen entstand, in denen die gesprochene Sprache nicht reichen konnte. Heute gibt es mehr als 300 Gebärdensprachen mit jeweils eigenen sprachlichen Prinzipien und Regeln: Italienische Gebärdensprache (LIS) Amerikanische Gebärdensprache (ASL) Englische Gebärdensprache (Britische Gebärdensprache BSL) usw.`,
  servicesWhysign_Btn: `FINDE MEHR HERAUS`,
  //Services Advantages
  servicesAdvantages_Heading: `DienstleistungenWhysign`,
  servicesAdvantages_para: `Rafiky kümmert sich bei Bedarf um die gesamte Organisation der Konferenz. Unser Team kann sich von der Pre-Event-Phase bis zur Post-Event-Phase um die Planung bis ins kleinste Detail kümmern. Dazu gehören eine Reihe von Dienstleistungen und Angeboten wie die Möglichkeit, das Logo oder den "Rednerumfang" anzupassen, die Erstellung einer Website, die ausschließlich der Bewerbung oder Registrierung für die Veranstaltung dient, oder sogar die Möglichkeit, mehr Dolmetscher und mehrere Sprachkombinationen für die Übersetzung anzufordern . Rafiky verfügt über ein unbegrenztes Netzwerk von branchenübergreifenden und muttersprachlichen Dolmetschern für insgesamt mehr als 200 Sprachen. Ein wirklich exklusiver Service ist das Dolmetschen in Gebärdensprache, das unerlässlich ist, um Ihre Webkonferenzen noch zugänglicher und umfassender zu gestalten.`,
  servicesAdvantages_Btn: `DIE REVOLUTION BEGINNT`,
  //Services Ready
...
von unserem Team betreut.
  ...
  servicesRemoteinterpreting_para: `Vertrauen Sie Rafikys Fernübersetzern! Die besten Profis für alle Ihre Bedürfnisse.`,
  servicesRemoteinterpreting_Btn: `KONTAKTIERE UNS`,
  //Qualified Interpreters
  qualifiedInterpreters_Heading: `Ferndolmetschdienst - Qualifizierte Dolmetscher`,
  qualifiedInterpreters_para: `Wir verfügen über ein umfangreiches Netzwerk hochprofessioneller und erfahrener mehrsprachiger Ferndolmetscher. Dank unserer Remote-Simultanübersetzungsplattform sind wir in der Lage, jede Sprache oder Sprachkombination überall und jederzeit bereitzustellen. Jeder Ferndolmetscher, mit dem wir zusammenarbeiten, durchläuft im Rahmen unserer Qualitätssicherung einen gründlichen Rekrutierungsprozess. Dadurch wird sichergestellt, dass die Dolmetscher in der Lage sind, das zu tun, was Sie brauchen.`,
  qualifiedInterpreters_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  qualifiedInterpreters_Firstcountingtest: `Sprachen`,
  qualifiedInterpreters_Seccountingtest: `Online-Veranstaltungen`,
  qualifiedInterpreters_Thirdcountingtest: `Professionelle Dolmetscher`,
  qualifiedInterpreters_FirstcardTitle: `Spezialisiert und zertifiziert`,
  qualifiedInterpreters_Firstcardpara: `Die Dolmetscher, die wir im Rahmen unserer Schulungen liefern, werden nach den höchsten Standards bewertet. Diese Dolmetscher werden Online-Interviews, Fähigkeitstests, IT-Tests und Kompetenz- und Spezialisierungstests unterzogen. Nach dem Bestehen der Tests werden diese Dolmetscher in der Verwendung der Rafiky-Plattform geschult, um sicherzustellen, dass sie sie einwandfrei verwenden können.`,
  qualifiedInterpreters_SeccardTitle: `Hoch qualifizierten `,
  qualifiedInterpreters_Seccardpara: `.Alle Ferndolmetscher, mit denen wir zusammenarbeiten, sind professionell ausgebildet und haben einen Abschluss in Konferenzdolmetschen von einer etablierten Universität oder einem Institut. Wir können jederzeit professionelle mehrsprachige Dolmetscher für jede Veranstaltung an jedem Ort bereitstellen. Bitte teilen Sie uns Ihre Bedürfnisse mit.`,
  qualifiedInterpreters_ThirdcardTitle: `Fachexperten`,
  qualifiedInterpreters_Thirdcardpara: `Unsere professionellen Dolmetscher kennen ihre Fachgebiete in- und auswendig und haben einen fundierten Hintergrund in ihrem jeweiligen Fachgebiet. Unsere spezialisierten Dolmetscher haben einen Hintergrund in den Bereichen Life Sciences, Finanzrecht und zwischenstaatliche Bereiche und verfügen alle über durchschnittlich 15 Jahre Dolmetscherfahrung. Dieses Maß an Fachkompetenz und Erfahrung macht unsere Dolmetscher für hochkarätige und/oder technische Veranstaltungen geeignet.`,
  qualifiedInterpreters_ForthcardTitle: `Qualitätskontrolle`,
  qualifiedInterpreters_Forthcardpara: `Um Ihnen Sicherheit zu geben, unterzeichnen unsere Dolmetscher Geheimhaltungsvereinbarungen, bevor sie mit Kunden arbeiten. Wenn Sie also vertrauliche Inhalte haben, die mit unseren Dolmetschern geteilt werden, sind diese Informationen sicher. Darüber hinaus wird jeder Ferndolmetscher regelmäßig überwacht und bewertet, um eine maximale Leistung sicherzustellen.`,
  //Services Ready
...
altung spezialisierte technische Unterstützung.`,
  ...
  remoteInterpreting_Thirdcountingtest: `Professionelle Dolmetscher`,
  remoteInterpreting_FirstcardTitle: `ENGAGIERTES TEAM`,
  remoteInterpreting_Firstcardpara: `Wir kümmern uns um jedes Detail. Wir begleiten Sie beratend und begleitend vom Anfang bis zum Ende des Projekts. Wir versetzen Sie in die Lage, mit minimalem Aufwand eine erfolgreiche Veranstaltung zu organisieren.`,
  remoteInterpreting_SeccardTitle: `PRE-EVENT-MARKETING-MANAGEMENT`,
  remoteInterpreting_Seccardpara: `Wir kümmern uns zunächst um das begleitende Marketing, d. h. um die Erstellung des Marketingmaterials, das für die Bewerbung des Produkts/der Dienstleistung erforderlich ist (Erstellung der der Veranstaltung gewidmeten Website mit dem Logo/der Marke/dem Warenzeichen des Kunden, Broschüren, Videos, technischer Dokumentation, Streaming der Konferenz auf sozialen Netzwerken etc.).`,
  remoteInterpreting_ThirdcardTitle: `AUSBILDUNG`,
  remoteInterpreting_Thirdcardpara: `In speziellen Schulungen zeigen wir Ihnen Schritt für Schritt, wie Sie Ihre Online-Konferenz erstellen, und schlagen Methoden zum Timing und gängige Praktiken vor. (Wenn auch der Dolmetscherdienst benötigt wird, wird auch eine Schulung für die Dolmetscher angeboten.)`,
  remoteInterpreting_ForthcardTitle: `TECHNISCHE TESTS VOR DER VERANSTALTUNG`,
  remoteInterpreting_Forthcardpara: `Wir führen alle notwendigen Tests durch, um die beste Benutzererfahrung zu garantieren: Wir überprüfen Verbindungen und Netzwerke auf korrekte Funktion von Geräten und technischen Geräten, Audio- und Videosystemen. Unser Expertenteam steht auch jederzeit bereit, um technische Probleme oder Störungen zu lösen.`,
  remoteInterpreting_FifthcardTitle: `TEILNEHMERVERWALTUNG`,
  remoteInterpreting_Fifthcardpara: `Wir kümmern uns um den gesamten Managementprozess: Anmeldeformulare für Teilnehmer Einladungen zur Tagesordnung E-Mail-Kampagnen Erinnerungen und alle anderen nützlichen Informationen für Ihre Veranstaltungsteilnehmer. Einladungs-E-Mails und Mitteilungen werden immer mit dem Logo/der Marke/dem Warenzeichen des Kunden personalisiert.`,
  remoteInterpreting_SixcardTitle: `KOMPLETTPAKET`,
  remoteInterpreting_Sixcardpara: `Kristallklares HD-Video/Audio White Label Service (Möglichkeit für den Kunden, seine/ihre Marke/Logo/Warenzeichen beizubehalten) Bildschirmfreigabe (Teilen von Multimedia-Content-Präsentationsbildern über den Bildschirm) Bis zu 1000 Videoteilnehmer und 5000 Zuschauer Live-Chat mit Galerieansicht Rafiky Rooms … und vieles mehr!`,
  remoteInterpreting_SeventhcardTitle: `TECHNISCHER SUPPORT`,
  remoteInterpreting_Seventhcardpara: `überprüft im Voraus die korrekte Funktion der Geräte, Hardware und Verbindungen erklärt den Referenten und Teilnehmern jeden Aspekt im Zusammenhang mit der Funktionsweise der Systeme beantwortet per Chat alle Fragen oder Wünsche der Teilnehmer kann jedes technische Problem lösen.`,
  remoteInterpreting_EightcardTitle: `SERVICES NACH DER VERANSTALTUNG`,
  remoteInterpreting_Eightcardpara: `Abschlussbericht (Dampfdauer Stimmen abgegebene Statistiken) Mediathek (Video-/Audioaufnahme HD-Videobearbeitung).`,
  //Services Advantages
  servicesAdvantages_Heading: `Die Vorteile`,
  servicesAdvantages_para: `Rafiky kümmert sich bei Bedarf um die gesamte Organisation der Konferenz. Unser Team kann sich von der Pre-Event-Phase bis zur Post-Event-Phase um die Planung bis ins kleinste Detail kümmern. Dazu gehören eine Reihe von Dienstleistungen und Angeboten wie die Möglichkeit, das Logo oder den "Rednerumfang" anzupassen, die Erstellung einer Website, die ausschließlich der Bewerbung oder Registrierung für die Veranstaltung dient, oder sogar die Möglichkeit, mehr Dolmetscher und mehrere Sprachkombinationen für die Übersetzung anzufordern . Rafiky verfügt über ein unbegrenztes Netzwerk von branchenübergreifenden und muttersprachlichen Dolmetschern für insgesamt mehr als 200 Sprachen. Ein wirklich exklusiver Service ist das Dolmetschen in Gebärdensprache, das unerlässlich ist, um Ihre Webkonferenzen noch zugänglicher und umfassender zu gestalten.`,
  servicesAdvantages_Btn: `DIE REVOLUTION BEGINNT`,
  //Services Pronto
  servicesPronto_Title: `FERTIG?`,
  servicesPronto_SubTitle: `Fordern Sie jetzt ein Angebot für Ihre nächste Veranstaltung an!`,
  servicesPronto_Btn: `FORDERN SIE JETZT EIN ANGEBOT AN`,
  //Zoness Partners
  zonessPartners_Title: `Vernetzung`,
  zonessPartners_SubTitle: `Tritt dem Team bei`,
  zonessPartners_para: `Treten Sie unserem Netzwerk von professionellen Dolmetschern, etablierten Sprachdienstleistern, Eventagenturen und Verleihfirmen für Audio-/Videogeräte bei. Wir entwickeln vorteilhafte Lösungen für alle unsere Partner, indem wir die besten Preise auf dem Markt anwenden!`,
  zonessPartners_Btn: `TRETEN SIE DEM NETZWERK BEI`,
  //Zoness Difference
  ...
  zonessDifference_ThirdHeading: `Verleihfirmen für Audio-/Videogeräte`,
  zonessDifference_Thirdpara: `Wir stellen Ihnen unsere Software/App als Ergänzung zu Ihrem Audio & Video Equipment zur Verfügung.`,
  zonessDifference_Btn: `TRETEN SIE DEM NETZWERK BEI`,
  //Zoness Partner
  zonessPartner_Title: `Werden Sie unser Partner`,
  zonessPartner_FirstcardHeading: `Professionelle Dolmetscher`,
  zonessPartner_Firstcardpara: `Die beste Technologie ist nichts ohne Ihre Stimme! Treten Sie unserem Netzwerk bei, indem Sie uns Ihren Lebenslauf zusenden. Wir arbeiten nur mit professionellen Dolmetschern mit mindestens 5 Jahren Erfahrung zusammen. Wir stellen Ihnen eine vollständige Schulung zur Verfügung, um sicherzustellen, dass Sie alle Funktionen der Motorsoftware verstehen. Dank der Nutzung der Rafiky-Plattform haben Sie auch viele Vorteile.`,
  zonessPartner_SeccardHeading: `Sprachdienstleister `,
  zonessPartner_Seccardpara: `Durch die Partnerschaft mit uns ermöglicht Ihnen unser globaler Marktplatz, international zu agieren und Ihren Umsatz zu steigern. Die Rafiky-Plattform bietet Partnern ein einzigartiges Tool, das die Logistik vereinfacht und die Kosten für die Bereitstellung von Dolmetschdiensten jederzeit und überall reduziert, mit erheblichen Einsparungen für die Kunden.`,
  zonessPartner_ThirdcardHeading: `Vermietung von Audio-/Videogeräten`,
  zonessPartner_Thirdcardpara: `Gemeinsam können wir unseren Kunden mit einer Kombination aus Hard- und Software einzigartige Lösungen anbieten. Durch den Beitritt zu unserem Partnernetzwerk können Sie an unseren Veranstaltungen auf der ganzen Welt teilnehmen und Ihr technisches Fachwissen sowohl vor Ort als auch aus der Ferne zur Verfügung stellen.`,
  zonessPartner_Btn: `TRETEN SIE DEM NETZWERK BEI`,
  //Choose Rafiky
  chooseRafiky_Title: `Warum Rafiky wählen? `,
  chooseRafiky_FirstcardTitle: `Bester Preis`,
  chooseRafiky_Firstcardpara: `Für den gleichen Service bieten wir unseren Partnern die besten Preise auf dem Markt.`,
  chooseRafiky_SeccardTitle: `SUPER BENUTZERFREUNDLICH!`,
  chooseRafiky_Seccardpara: `Laden Sie unsere Anwendung herunter und sehen Sie den Erfolg Ihrer Veranstaltungen und Meetings.`,
  chooseRafiky_ThirdcardTitle: `Schulung & Zertifizierung`,
  chooseRafiky_Thirdcardpara: `Wir bieten allen unseren Mitarbeitern spezifische Schulungen mit abschließender Zertifizierung auf der Grundlage der erreichten Niveaus. `,
  chooseRafiky_ForthcardTitle: `Audio- und Videoqualität`,
  chooseRafiky_Forthcardpara: `Unsere Plattform wurde unter Verwendung der besten Qualitätsstandards in Bezug auf die Leistung der Audio-/Videoqualität entwickelt. `,
  chooseRafiky_FifthcardTitle: `INNOVATIVE VISION`,
  chooseRafiky_Fifthcardpara: `Treten Sie dem Netzwerk technologisch fortschrittlicher Unternehmen bei, die einzigartige Lösungen anbieten können.`,
  chooseRafiky_SixcardTitle: `BARRIEREFREIHEIT`,
  chooseRafiky_Sixcardpara: `Von überall aus war der Zugriff auf unsere Software/App noch nie so einfach.`,
  chooseRafiky_SeventhcardTitle: `Verfügbarkeit 24/24 - 7/7`,
  chooseRafiky_Seventhcardpara: `Dank unserer Büros in verschiedenen Teilen der Welt ist unser Team 7 Tage die Woche 24 Stunden am Tag verfügbar.`,
  chooseRafiky_EightcardTitle: `+ Als 200 Sprachen`,
  chooseRafiky_Eightcardpara: `Wir können Ihrem Publikum jederzeit und überall bis zu 200 Sprachen anbieten! `,
  //Zoness Started
  zonessStarted_Title: `Lass uns anfangen`,
  zonessStarted_SubTitle: `VERWENDEN SIE DIE BESTE ÜBERSETZUNGSTECHNOLOGIE DER WELT`,
  zonessStarted_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Equipment Rental
  equipmentRental_Heading: `Vermietung von Dolmetscherausrüstung Die fortschrittlichste Technologie für Agenturen zur Vermietung von Ausrüstungen`,
  equipmentRental_para: `Unsere revolutionäre Software für das Ferndolmetschen in Kombination mit leistungsstarker, hochmoderner Hardware, die von den besten Ausrüstungsverleihern geliefert wird, ist die perfekte Kombination für erfolgreiche Veranstaltungen.`,
  equipmentRental_Btn: `KONTAKTIERE UNS`,
  //Common Goals
  commonGoals_Heading: `Vermietung von Dolmetschtechnik Gemeinsam für gemeinsame Ziele`,
  commonGoals_para: `Thanks to a well-established partnership with the most important technical equipment rental agencies for events Rafiky represents the best choice for any type of multilingual event. Working together with the most important suppliers of technical equipment for events allows us to make the most of the potential of our platform offering an unrivaled interpreting service. Join our network to become an OFFICIAL RAFIKY SUPPLIER and have the EXCLUSIVE IN YOUR AREA!`,
  commonGoals_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  commonGoals_FirstcountingTest: `Sprachen`,
  commonGoals_SeccountingTest: `Online-Veranstaltungen`,
  commonGoals_ThirdcountingTest: `Professionelle Dolmetscher`,
  commonGoals_FirstcardHeading: `ZU IHREN DIENSTENE`,
  commonGoals_Firstcardpara: `Unsere revolutionäre Plattform für das Ferndolmetschen zu Ihren Diensten. Rafiky steht ab sofort allen Veranstaltungsdienstleistern technischer Ausstattung und/oder Sprachdienstleistern zur Verfügung, die ihre Gewinne steigern wollen, indem sie das Potenzial einer einzigartigen Software ausschöpfen.`,
  commonGoals_SeccardHeading: `WERT HINZUGEFÜGT `,
  commonGoals_Seccardpara: `Durch die Integration unserer Plattform mit den verschiedenen Arten von angebotenen Dienstleistungen und deren Anpassung an die spezifischen Bedürfnisse verschiedener Kunden können sich unsere Partner auf eine solide Zusammenarbeit verlassen, um erfolgreiche Veranstaltungen zu gestalten.`,
  commonGoals_ThirdHeading: `WELTWEITE EREIGNISSE`,
  commonGoals_Thirdpara: `Dank unseres gut etablierten Netzwerks sind wir stolz darauf, eine globale Abdeckung für jede Art von Online-Event anbieten zu können. Rafiky wird jetzt für die Erstellung von Online-Events auf der ganzen Welt verwendet.`,
  commonGoals_ForthHeading: `MAXIMALE ZUGÄNGLICHKEIT`,
  commonGoals_Forthpara: `Durch die Kombination von Remote-Simultandolmetschen und einem einfachen und intuitiven Remote-Teilnahmesystem macht es Rafiky möglich, jede Art von Online-Veranstaltung einem vielfältigen Publikum zugänglich zu machen.`,
  commonGoals_FifthHeading: `Kostenlose Tryngness`,
  commonGoals_Fifthpara: `Wir bieten Ihrem Team die notwendige Unterstützung, um unsere Plattform optimal zu nutzen: Wir führen kostenlos spezifische Trainingstests und Schulungen durch.`,
  commonGoals_SixthHeading: `WEISSES ETIKETT`,
  commonGoals_Sixthpara: `Steigern Sie mit uns Ihre Markenbekanntheit! Unser White-Label-Service gibt Ihnen die Möglichkeit, unsere Plattform zu nutzen und gleichzeitig Ihr Logo/Ihre Marke/Ihr Warenzeichen beizubehalten. Völlig kostenlos.`,
  commonGoals_SevenHeading: `GELEGENHEIT`,
  commonGoals_Sevenpara: `Unsere Plattform verbindet jeden Tag Benutzer in Echtzeit und aus der ganzen Welt. Durch die Integration zwischen Ihrer Hardware und unserer Software erhöhen Sie Ihre Möglichkeiten und Ihren Verdienst Sie agieren international und in den unterschiedlichsten Bereichen erweitern Sie Ihr Know-how und erbringen Ihre Dienstleistungen weiterhin unter Ausnutzung der Möglichkeiten Potenzial einer einzigartigen Software.!`,
  commonGoals_EightHeading: `NICHT NUR INTERPRETATION`,
  commonGoals_Eightpara: `Rafiky ist eine Software, die für mehrsprachige Veranstaltungen und mehr verwendet wird. Nutzen Sie eine leistungsstarke und sichere Plattform für Ihre Online-Streams, Social-Media-Streams und mehr! Entdecken Sie unsere speziellen Abonnementpakete, die für jeden Bedarf diversifiziert sind.`,
  //Solid Network
  solidNetwork_Heading: `Ein solides Netzwerk für einen exzellenten Service`,
  solidNetwork_para: `Wir glauben fest an Teamarbeit. Wir sind stolz darauf, mit den besten Vermietungsagenturen für Simultanübersetzungsausrüstung zusammenzuarbeiten und unseren Kunden wirklich einzigartige Erfahrungen zu bieten. Die Stärke unseres Netzwerks ermöglicht es uns, durch die Vereinigung von Wissen, Fähigkeiten und Mitteln in Synergie zu arbeiten, um maximale Ergebnisse und ein gemeinsames Ziel, die Zufriedenheit unserer Kunden, zu erzielen. Know-how-Teilen und Wachstum sind die Basis unserer Idee einer virtuellen Geschäftserweiterung. Treten Sie unserem Netzwerk bei!`,
  solidNetwork_Btn: `FINDE MEHR HERAUS`,
  //Equipment Ready
  equipmentReady_Title: `BEREIT`,
  equipmentReady_SubTitle: `VERÄNDERE DIE WELT MIT EINEM KLICK!`,
  equipmentReady_Btn: `FORDERN SIE JETZT EIN ANGEBOT AN`,
  //Translation Agencies
  translationAgencies_Title: `Agentur für Ferndolmetschen`,
  translationAgencies_SubTitle: `Die beste Software mit Ferndolmetschern für Dolmetscheragenturen`,
  translationAgencies_para: `Die fortschrittlichste Technologie im Dolmetschsektor kombiniert mit den Fähigkeiten und Erfahrungen der besten Dolmetscher der Welt. Treten Sie unserem Netzwerk bei!`,
  translationAgencies_Btn: `TRETEN SIE DEM NETZWERK BEI`,
  //Working Together
  WorkingTogether_Heading: `Ferndolmetschdienst Gemeinsam für gemeinsame Ziele`,
  WorkingTogether_para: `Dank einer gut etablierten Partnerschaft mit den wichtigsten Dolmetscheragenturen in Italien und auf der ganzen Welt ist Rafiky die beste Wahl für jede Art von mehrsprachiger Online-Veranstaltung. Die Zusammenarbeit mit den wichtigsten Sprachdienstleistern ermöglicht es uns, das Potenzial unserer Plattform mit einem konkurrenzlosen Übersetzungsservice optimal auszuschöpfen.`,
  WorkingTogether_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  WorkingTogether_FirstcountingTest: `Sprachen`,
  WorkingTogether_SeccountingTest: `Online-Veranstaltungen`,
  workingTogether_ThirdcountingTest: `Professionelle Dolmetscher`,
  workingTogether_FirstcardHeading: `ZU IHREN DIENSTEN`,
  workingTogether_Firstcardpara: `Unsere revolutionäre Plattform für das Ferndolmetschen zu Ihren Diensten. Rafiky steht jetzt all jenen Anbietern von Veranstaltungstechnik, Veranstaltungstechnik und/oder Sprachdiensten zur Verfügung, die ihre Gewinne steigern möchten, indem sie das Potenzial einer einzigartigen Software ausschöpfen.`,
  workingTogether_SeccardHeading: `WERT HINZUGEFÜGT `,
  workingTogether_Seccardpara: `Durch die Integration unserer Plattform mit den verschiedenen Arten von angebotenen Dienstleistungen und deren Anpassung an die spezifischen Bedürfnisse verschiedener Kunden können sich unsere Partner auf eine solide Zusammenarbeit verlassen, um erfolgreiche Veranstaltungen zu gestalten. `,
  workingTogether_ThirdHeading: `WELTWEITE EREIGNISSE`,
  workingTogether_Thirdpara: `Dank unseres gut etablierten Netzwerks sind wir stolz darauf, eine globale Abdeckung für jede Art von Online-Event anbieten zu können. Rafiky wird jetzt für die Erstellung von Online-Events auf der ganzen Welt verwendet.`,
  workingTogether_ForthHeading: `MAXIMALE ZUGÄNGLICHKEIT`,
  workingTogether_Forthpara: `Durch die Kombination von Remote-Simultandolmetschen und einem einfachen und intuitiven Remote-Teilnahmesystem macht es Rafiky möglich, jede Art von Online-Veranstaltung einem vielfältigen Publikum zugänglich zu machen.`,
  workingTogether_FifthHeading: `PERFEKTE KOMBINATION`,
  workingTogether_Fifthpara: `Wir stellen unsere Software zur Verfügung. Sie die Dolmetscher. Dank Rafiky können Ihre professionellen Dolmetscher jederzeit von ihrem Arbeitsplatz aus einen hochwertigen Dolmetschdienst anbieten, während die Gäste die Konferenz aus der Ferne verfolgen.`,
  workingTogether_SixthHeading: `KOSTENLOSE SCHULUNGEN`,
  workingTogether_Sixthpara: `Wir bieten Ihrem Team die notwendige Unterstützung, um unsere Plattform optimal zu nutzen: Wir führen kostenlos spezifische Trainingstests und Schulungen durch.`,
  workingTogether_SeventhHeading: `WEISSES ETIKETT`,
  workingTogether_Seventhpara: `Steigern Sie mit uns Ihre Markenbekanntheit! Unser White-Label-Service gibt Ihnen die Möglichkeit, unsere Plattform zu nutzen und gleichzeitig Ihr Logo/Ihre Marke/Ihr Warenzeichen beizubehalten. Völlig kostenlos.`,
  workingTogether_EightHeading: `KEINE STRESS`,
  workingTogether_Eightpara: `Wir kümmern uns um jedes Detail und bieten die gesamte technische Unterstützung, die für eine erfolgreiche Veranstaltung erforderlich ist. Das Herunterladen der Anwendung und ein Laptop mit guter Internetverbindung dauern einige Minuten. Herunterladen anmelden anhören!`,
  //Interpreting Company
  solidNetwork_Heading: `Teledolmetscher-Unternehmen ein solides Netzwerk für einen exzellenten Service`,
  solidNetwork_para: `Wir glauben fest an Teamarbeit. Wir sind stolz darauf, mit den besten Dolmetschagenturen in Italien und im Ausland zusammenzuarbeiten, um unseren Kunden wirklich einzigartige Erfahrungen zu bieten. Die Stärke unseres Netzwerks ermöglicht es uns, durch die Vereinigung von Wissen, Fähigkeiten und Mitteln in Synergie zu arbeiten, um maximale Ergebnisse und ein gemeinsames Ziel, die Zufriedenheit unserer Kunden, zu erzielen. Know-how-Teilen und Wachstum sind die Basis unserer Idee einer virtuellen Geschäftserweiterung. Treten Sie unserem Netzwerk bei!`,
  solidNetwork_Btn: `FINDE MEHR HERAUS`,
  //Translation Ready
  translationReady_Title: `BEREIT`,
  translationReady_SubTitle: `Fordern Sie jetzt ein Angebot für Ihre nächste Veranstaltung an!`,
  translationReady_Btn: `FORDERN SIE JETZT EIN ANGEBOT AN`,
  //All Languages
  allLanguages_Heading: `Dolmetschen in allen Sprachen`,
  allLanguages_para: `Auf Rafiky finden Sie dank der Hilfe von Branchenexperten und muttersprachlichen Übersetzern Dolmetschdienste in allen Sprachen.`,
  allLanguages_Btn: `AM MEISTEN NACHGEFRAGTE SPRACHEN`,
  //Interpreters All
  ...
  ourOffer_Secpara: `Alle unsere Dienstleistungen unterliegen strengen Kontrollprozessen in Übereinstimmung mit unserer Richtlinie, um unsere Kunden zu schützen und die Aufrechterhaltung der höchsten Qualitätsstandards zu gewährleisten. Unser Qualitätsmanager steht Ihnen während des gesamten Prozesses zur Verfügung, um auf alle Ihre Bedürfnisse einzugehen. Auf Rafiky finden Sie sichere und zertifizierte Webkonferenzdienste mit Dolmetschern in allen Sprachen.`,
  ourOffer_ThirdHeading: `Personalisiertes Projektmanagement:`,
  ourOffer_Thirdpara: `Jeder Kunde kann sich auf ein ihm gewidmetes Team verlassen, das sich um die Realisierung des Projekts in allen Phasen kümmert: von der Analyse und dem Verständnis der Anfrage bis zur Auswahl des am besten geeigneten Linguisten basierend auf Sprachkombination und Branche der Spezialisierung bis hin zur termingerechten Lieferung des fertigen Produkts. Unsere Gruppe von Dolmetschern in allen Sprachen und LIS geht auf die Bedürfnisse von Unternehmen ein und stellt jeden Benutzer zufrieden. Bei Global Voices ist Ihr Projekt immer in guten Händen.`,
  ourOffer_ForthHeading: `Volle Unterstützung nach Lieferung:`,
  ourOffer_Forthpara: `Der Support nach Projektabschluss ist ein wichtiger Schritt zur vollständigen Zufriedenheit unserer Kunden und der Eckpfeiler der Dienstleistungen von Global Voices. Das Ihnen gewidmete Team steht Ihnen jederzeit für alle Anfragen und Eventualitäten zur Verfügung.`,
  ourOffer_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  ourOffer_Language1: "UK ENGLISCH",
  ourOffer_Language2: "FRANZÖSISCH",
  ourOffer_Language3: "SPANISCH",
  ourOffer_Language4: "US ENGLISCH",
  ourOffer_Language5: "CHINESISCH",
  ourOffer_Language6: "RUSSISCH",
  ourOffer_Title: `Die beliebtesten Sprachen`,
  ourOffer_para: `Nachfolgend finden Sie einige Beispiele für die am häufigsten nachgefragten Sprachen. Wir bieten auch Unterstützung für alle anderen Sprachen, also zögern Sie nicht, ein Angebot für Ihr Projekt anzufordern.`,
  //Lets Begin
  letsBegin_Title: `LASS UNS ANFANGEN`,
  letsBegin_SubTitle: `Bereit für eine echte Veränderung? Lassen Sie es uns gemeinsam angehen!`,
  letsBegin_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //British English
  britishEnglish_Heading: `Verdolmetschung in britisches Englisch`,
  britishEnglish_para: `Unser Englisch-Dolmetschdienst, der von erfahrenen Übersetzern geleitet wird, die seit Jahren in der Branche tätig sind, ermöglicht es Ihnen, Ihre Geschäftsaussichten zu verbessern. Finden Sie heraus, wie Sie dank Rafikys Dolmetschern wachsen können!`,
  britishEnglish_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Italian English
  italianEnglish_Heading: `Italienisch-Englisch-Dolmetscherdienste für Ihr Unternehmen!`,
  italianEnglish_para: `Suchen Sie eine professionelle Agentur, die Ihnen schnell einen zuverlässigen Englisch-Italienisch-Dolmetscherdienst zur Verfügung stellt? Suchen Sie einen erfahrenen und kompetenten Englisch-Dolmetscher? Rafiky wählt nur die besten englischsprachigen Fachleute aus, um qualitativ hochwertige Sprachdienste anzubieten, die eine natürliche und effektive Kommunikation zwischen Großbritannien und Unternehmen auf der ganzen Welt ermöglichen. Wir wissen, wie schwierig es ist, ein modernes und effizientes Ferndolmetschsystem für Englisch zu finden, weshalb wir sicherstellen, dass wir immer die richtigen Leute auswählen! Das Geheimnis unserer akkuraten und gut lokalisierten Übersetzungen ins Englische liegt darin, dass wir uns ausschließlich auf professionelle muttersprachliche Übersetzer verlassen. Bei Rafiky finden Sie den passenden Englisch-Dolmetscher für Ihr Unternehmen. `,
  italianEnglish_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Italian Into English
  italianIntoEnglish_Heading: `So wählen Sie einen professionellen Dolmetscher aus dem Italienischen ins Englische aus`,
  italianIntoEnglish_para: `Englisch ist die am weitesten verbreitete Sprache der Welt mit etwa 1,5 Milliarden Sprechern, die 20 % der Weltbevölkerung ausmachen. Obwohl nur 360 Millionen Menschen Englisch als Muttersprache sprechen, haben Millionen es als Zweitsprache gelernt und viele große internationale Märkte haben Englisch als Amtssprache eingeführt. Da es sich um die am weitesten verbreitete Sprache der Welt handelt, sollte jedes Unternehmen, das am globalen Handel interessiert ist, über einen professionellen Englischdolmetscher sowie über Fernübersetzungs- und Dolmetscherdienste für Englisch verfügen. Um eine erfolgreiche Partnerschaft mit dem Vereinigten Königreich, Kanada und den Vereinigten Staaten sowie Indien und zahlreichen Ländern in Afrika und Ozeanien aufzubauen, ist es unerlässlich, einen professionellen Dolmetscher aus dem Italienischen ins Englische zu wählen, der in der Lage ist, selbst die kleinsten Nuancen der Sprache zu erkennen. Auf Rafiky stellen wir einen schnellen und funktionalen Webkonferenzdienst mit einem englischen Dolmetscher sicher, der für alle Arten von Unternehmen geeignet ist. Kommen Sie und testen Sie es jetzt!`,
  italianIntoEnglish_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Interpretation Services
  interpretationServices_Heading: `Dolmetscherdienste in Englisch und Lis`,
  interpretationServices_para: `Bei Rafiky können Sie sich auf die Professionalität eines Gebärdensprachdolmetschers vom Italienischen ins Englische verlassen. Alle Teilnehmer Ihrer Veranstaltung können dank Rafikys Dolmetscherdienst in Englisch und Lis das Gespräch in Echtzeit verfolgen. Wenn Sie nach einer Möglichkeit suchen, Webkonferenz-Meetings mit einem englischen Dolmetscher zu verwalten, ist dies der schnellste Weg. Wir bieten Ihnen die Unterstützung eines professionellen Englisch-Dolmetschers, der die Sprache in all ihren Variationen kennt. Wenn Sie sich außerdem für die Unterstützung eines Gebärdensprachdolmetschers vom Italienischen ins Englische entscheiden, werden Sie jedes Publikum zufrieden stellen.`,
  interpretationServices_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Most Popular
  mostPopular_Heading: `Die beliebtesten Sprachen`,
  mostPopular_para: `Nachfolgend finden Sie einige Beispiele für die am häufigsten nachgefragten Sprachen. Wir bieten auch Unterstützung für alle anderen Sprachen, also zögern Sie nicht, ein Angebot für Ihr Projekt anzufordern.`,
  //Lets Begin
  letsBegin_Title: `LASS UNS ANFANGEN`,
  letsBegin_SubTitle: `Bereit für eine echte Veränderung? Lassen Sie es uns gemeinsam angehen!`,
  letsBegin_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //American English
  americanEnglish_Heading: `Dolmetschen in amerikanischem Englisch`,
  americanEnglish_para: `Unser Englisch-Dolmetschdienst, der von erfahrenen Übersetzern geleitet wird, die seit Jahren in der Branche tätig sind, ermöglicht es Ihnen, Ihre Geschäftsaussichten zu verbessern. Finden Sie heraus, wie Sie dank Rafikys Dolmetschern wachsen können!`,
  americanEnglish_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Italian English
  italianEnglish_Heading: `Italienisch-Englisch-Dolmetscherdienste für Ihr Unternehmen!`,
  italianEnglish_para: `Suchen Sie eine professionelle Agentur, die Ihnen schnell einen zuverlässigen Englisch-Italienisch-Dolmetscherdienst zur Verfügung stellt? Suchen Sie einen erfahrenen und kompetenten Englisch-Dolmetscher? Rafiky wählt nur die besten englischsprachigen Fachleute aus, um qualitativ hochwertige Sprachdienste anzubieten, die eine natürliche und effektive Kommunikation zwischen Großbritannien und Unternehmen auf der ganzen Welt ermöglichen. Wir wissen, wie schwierig es ist, ein modernes und effizientes Ferndolmetschsystem für Englisch zu finden, weshalb wir sicherstellen, dass wir immer die richtigen Leute auswählen! Das Geheimnis unserer akkuraten und gut lokalisierten Übersetzungen ins Englische liegt darin, dass wir uns ausschließlich auf professionelle muttersprachliche Übersetzer verlassen. Bei Rafiky finden Sie den passenden Englisch-Dolmetscher für Ihr Unternehmen. `,
  italianEnglish_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Italian English Interpreting
  italianEnglishInterpreting_Heading: `So wählen Sie einen professionellen Dolmetscher aus dem Italienischen ins Englische aus`,
  italianEnglishInterpreting_para: `Englisch ist die am weitesten verbreitete Sprache der Welt mit etwa 1,5 Milliarden Sprechern, die 20 % der Weltbevölkerung ausmachen. Obwohl nur 360 Millionen Menschen Englisch als Muttersprache sprechen, haben Millionen es als Zweitsprache gelernt und viele große internationale Märkte haben Englisch als Amtssprache eingeführt. Da es sich um die am weitesten verbreitete Sprache der Welt handelt, sollte jedes Unternehmen, das am globalen Handel interessiert ist, über einen professionellen Englischdolmetscher sowie über Fernübersetzungs- und Dolmetscherdienste für Englisch verfügen. Um eine erfolgreiche Partnerschaft mit dem Vereinigten Königreich, Kanada und den Vereinigten Staaten sowie Indien und zahlreichen Ländern in Afrika und Ozeanien aufzubauen, ist es unerlässlich, einen professionellen Dolmetscher aus dem Italienischen ins Englische zu wählen, der in der Lage ist, selbst die kleinsten Nuancen der Sprache zu erkennen. Auf Rafiky stellen wir einen schnellen und funktionalen Webkonferenzdienst mit einem englischen Dolmetscher sicher, der für alle Arten von Unternehmen geeignet ist. Kommen Sie und testen Sie es jetzt!`,
  italianEnglishInterpreting_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Services In English
  servicesInEnglish_Heading: `Dolmetscherdienste in Englisch und Lis`,
  servicesInEnglish_para: `Bei Rafiky können Sie sich auf die Professionalität eines Gebärdensprachdolmetschers vom Italienischen ins Englische verlassen. Alle Teilnehmer Ihrer Veranstaltung können dank Rafikys Dolmetscherdienst in Englisch und Lis das Gespräch in Echtzeit verfolgen. Wenn Sie nach einer Möglichkeit suchen, Webkonferenz-Meetings mit einem englischen Dolmetscher zu verwalten, ist dies der schnellste Weg. Wir bieten Ihnen die Unterstützung eines professionellen Englisch-Dolmetschers, der die Sprache in all ihren Variationen kennt. Wenn Sie sich außerdem für die Unterstützung eines Gebärdensprachdolmetschers vom Italienischen ins Englische entscheiden, werden Sie jedes Publikum zufrieden stellen.`,
  servicesInEnglish_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Most Popular
  mostPopular_Heading: `Die beliebtesten Sprachen`,
  mostPopular_para: `Nachfolgend finden Sie einige Beispiele für die am häufigsten nachgefragten Sprachen. Wir bieten auch Unterstützung für alle anderen Sprachen, also zögern Sie nicht, ein Angebot für Ihr Projekt anzufordern.`,
  //Lets Begin
  ...
  interpretationFrench_Heading: `Dolmetschen auf Französisch`,
  interpretationFrench_para: `Unser Englisch-Dolmetschdienst, der von erfahrenen Übersetzern geleitet wird, die seit Jahren in der Branche tätig sind, ermöglicht es Ihnen, Ihre Geschäftsaussichten zu verbessern. Finden Sie heraus, wie Sie dank Rafikys Dolmetschern wachsen können!`,
  interpretationFrench_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Italian French
  italianFrench_Heading: `Italienisch-Französisch-Dolmetscherdienste für Ihr Unternehmen!`,
  italianFrench_para: `Suchen Sie einen Französisch-Dolmetscher, der Ihnen in kurzer Zeit eine zuverlässige Übersetzung garantieren kann? Rafiky wählt die besten französischsprachigen Fachleute aus, um Ihnen zu helfen, eine schnelle Lösung zu finden. Französisch ist komplexer als erwartet und kann für diejenigen, die die Geheimnisse seiner Grammatik nicht kennen, schwierig sein. Rafikys Dolmetscher, die es gewohnt sind, schnell und engagiert zu arbeiten, sind bestrebt, Ihnen einen außergewöhnlichen Service zu bieten. Was auch immer Ihre Anfrage ist, wir werden versuchen, Sie mit der gebotenen Aufmerksamkeit und Professionalität zufrieden zu stellen. Auf Rafiky finden Sie Dolmetscherdienste für Französisch-Italienisch, die verschiedene Bereiche abdecken. Von der Kongresswelt bis zur Kanzleiwelt finden Sie alles, was Sie brauchen. Sie haben sogar Zugang zu einem Dolmetschersystem für Französisch und Lis mit einem Gebärdensprachdolmetscher von Italienisch nach Französisch.`,
  italianFrench_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Why Choose
  whyChoose_Heading: `Warum einen Ferndolmetschdienst für Französisch wählen?`,
  whyChoose_para: `Die Hilfe eines professionellen Französisch-Dolmetschers kann bei Ihren Remote-Meetings für Klarheit und Sicherheit sorgen. Der Ferndolmetscherdienst von Rafiky für Französisch soll Ihnen Zeit und Geld sparen. Wenn Sie keinen physischen Französisch-Dolmetscher kontaktieren müssen, sondern den Online-Service nutzen können, sparen Sie viel. Sie können sich ein Webkonferenzsystem mit einem französischen Dolmetscher sichern, wo immer Sie sind, und jederzeit die Geschwindigkeit von Rafiky nutzen. Ein professioneller Dolmetscher aus dem Italienischen ins Französische steht Ihnen jederzeit für Notfälle zur Verfügung und hilft Ihnen, unvorhergesehene Situationen zu lösen. Darüber hinaus können Sie Unterstützung für alle Arten von Teilnehmern sicherstellen, damit alle die Veranstaltung genießen können. Wenn Sie sich für den Dolmetscherdienst für Französisch und Lis entscheiden, können Sie einen Gebärdensprachdolmetscher aus dem Italienischen ins Französische auswählen, der sich um alle Ihre Gäste kümmern kann.`,
  whyChoose_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //French Interpreter
  frenchInterpreter_Heading: `Rafiky Ihr Webkonferenzdienst mit französischem Dolmetscher`,
  frenchInterpreter_para: `Finden Sie Ihren vertrauenswürdigen professionellen Italienisch-Französisch-Dolmetscher über das Rafiky-System. Übersetzer, muttersprachliche Experten und Dolmetscher aus der ganzen Welt wissen, wie sie Sie auf Ihrem Weg zum beruflichen Wachstum begleiten können. Dolmetschen ist eine großartige Waffe, die Ihnen zur Verfügung steht, um Ihre Verkaufskraft zu steigern. Machen Sie das Beste daraus und finden Sie heraus, wie Sie den perfekten professionellen Französisch-Dolmetscher für Ihr Unternehmen finden. Fordern Sie ein sofortiges Angebot an, um alle Zweifel auszuräumen!`,
  frenchInterpreter_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Most Popular
  mostPopular_Heading: `Die beliebtesten Sprachen`,
  mostPopular_para: `Nachfolgend finden Sie einige Beispiele für die am häufigsten nachgefragten Sprachen. Wir bieten auch Unterstützung für alle anderen Sprachen, also zögern Sie nicht, ein Angebot für Ihr Projekt anzufordern.`,
  //Lets Begin
  ...
  interpretationSpanish_Heading: `Dolmetschen auf Spanisch`,
  interpretationSpanish_para: `Unsere Dolmetscher, die seit Jahren in der Branche tätig sind, sind in der Lage, Ihnen Dolmetscherdienste für Spanisch in höchster Qualität und Wettbewerbsfähigkeit anzubieten.`,
  interpretationSpanish_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Italian Spanish
  italianSpanish_Heading: `Italienisch-Spanisch-Dolmetscherdienste für Ihr Unternehmen`,
  italianSpanish_para: `Weltweit gibt es ungefähr 405 Millionen spanische Muttersprachler. Die Dynamik dieser Sprache hat dafür gesorgt, dass sie sich schnell und erfolgreich verbreitet hat. Immer mehr Unternehmen fragen Übersetzungen und Ferndolmetschdienste in Spanisch an, um sich mit den renommiertesten spanischen Unternehmen zu vergleichen. Rafiky, unsere innovative Dolmetscheragentur, stellt Ihnen fachkundige und kompetente Übersetzer zur Verfügung, die jedes Kommunikationsproblem lösen können. Wer einen schnellen und effizienten Spanisch-Italienisch-Dolmetscherdienst sucht, findet in Rafiky einen Verbündeten, auf den er sich jederzeit verlassen kann. Beginnen Sie sofort mit dem Testen unserer Dienstleistungen und wählen Sie den am besten geeigneten Spanisch-Dolmetscher für Ihr Unternehmen aus.`,
  italianSpanish_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Find Your
  findYour_Heading: `Finden Sie Ihren professionellen Dolmetscher vom Italienischen ins Spanische`,
  findYour_para: `Suchen Sie einen Webkonferenzdienst mit einem spanischen Dolmetscher? Möchten Sie einen Weg finden, alle Ihre virtuellen Veranstaltungen aus der Ferne zu verwalten? Auf Rafiky treffen Sie die richtigen Leute, auf die Sie sich für Ihre erfolgreichen Meetings verlassen können. Wir wählen für Sie nur die besten professionellen Spanisch-Dolmetscher aus, die seit Jahren in der Übersetzungsbranche tätig sind und wissen, wie man mit Druck umgeht. Eine präzise, ​​aber schnelle Übersetzung erfordert ein hohes Maß an Fachkenntnissen. Aus diesem Grund ist es wichtig, einen spanischen Ferndolmetschdienst zu wählen, der den Namen sicher und professionell verdient. Was Rafiky Ihnen anbieten möchte, ist ein vollständiger Service in jedem Teil. Bei Ihren zukünftigen Geschäftsterminen steht Ihnen ein erfahrener Spanisch-Dolmetscher zur Verfügung, der die Situation am besten meistern wird. Beginnen Sie jetzt mit der Erweiterung Ihres Geschäfts und finden Sie Ihren professionellen Italienisch-Spanisch-Dolmetscher Probieren Sie Rafikys Dolmetschen aus!`,
  findYour_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Interpretation Services
  interpretationServices_Heading: `Dolmetscherdienste in Spanisch und Lis`,
  interpretationServices_para: `Bei Rafikyx können Sie sich auf die Professionalität eines Gebärdensprachdolmetschers vom Italienischen ins Spanische verlassen. Alle Teilnehmer Ihrer Veranstaltung können dank Rafikys Dolmetscherdienst in Spanisch und Lis das Gespräch in Echtzeit verfolgen. Wenn Sie nach einer Möglichkeit suchen, Webkonferenz-Meetings mit einem spanischen Dolmetscher zu verwalten, ist dies der schnellste Weg. Wir bieten Ihnen die Unterstützung eines professionellen Spanisch-Dolmetschers, der die Sprache in all ihren Variationen kennt. Wenn Sie sich außerdem für die Unterstützung eines Gebärdensprachdolmetschers vom Italienischen ins Spanische entscheiden, werden Sie jede Art von Publikum zufrieden stellen.`,
  interpretationServices_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Most Popular
  mostPopular_Heading: `Die beliebtesten Sprachen`,
  mostPopular_para: `Nachfolgend finden Sie einige Beispiele für die am häufigsten nachgefragten Sprachen. Wir bieten auch Unterstützung für alle anderen Sprachen, also zögern Sie nicht, ein Angebot für Ihr Projekt anzufordern.`,
  ...
  chineseInterpreting_Heading: `Chinesisches Dolmetschen`,
  chineseInterpreting_para: `Unsere Dolmetscher, die chinesische Muttersprachler sind und über jahrelange Erfahrung in der Branche verfügen, sind in der Lage, Ihnen Übersetzungs- und Dolmetscherdienste in Chinesisch mit höchster Qualität und Wettbewerbsfähigkeit anzubieten.`,
  chineseInterpreting_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Chinese Italian
  chineseItalian_Heading: `Übersetzungs- und Dolmetschdienste Chinesisch Italienisch`,
  chineseItalian_para: `Chinesisch ist eine der meistgesprochenen Sprachen der Welt. Es wird geschätzt, dass etwa 1 Milliarde 213 Millionen Menschen in der Lage sind, fließend Chinesisch zu sprechen. In der Welt der Industrie gilt China als Weltmacht, der es sich lohnt, sich anzuschließen. In diesem Zusammenhang kann es sich als mehr als nützlich erweisen, einen Chinesisch-Dolmetscher zu haben, der schnell und klar übersetzen kann. Wenn Sie nach einer Möglichkeit suchen, die Verkaufschancen Ihres Unternehmens zu erweitern und näher an den chinesischen Markt heranrücken möchten, ist Rafiky die richtige Chinesisch-Italienisch-Dolmetscheragentur für Sie! Hier finden Sie Webkonferenzdienste mit chinesischen Dolmetschern gefolgt von Experten, die die verschiedenen Nuancen der Sprache kennen.`,
  chineseItalian_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Chinese interpreter
  chineseInterpreter_Heading: `Warum sollten Sie sich auf einen professionellen Chinesisch-Dolmetscher verlassen?`,
  ...
  russianInterpreting_Heading: `Dolmetschen auf Russisch`,
  russianInterpreting_para: `Unser Englisch-Dolmetschdienst, der von erfahrenen Übersetzern geleitet wird, die seit Jahren in der Branche tätig sind, ermöglicht es Ihnen, Ihre Geschäftsaussichten zu verbessern. Finden Sie heraus, wie Sie dank Rafikys Dolmetschern wachsen können!`,
  russianInterpreting_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Russian Italian
  russianItalian_Heading: `Russisch Italienisch Übersetzungs- und Dolmetscherdienste für Ihr Unternehmen! `,
  russianItalian_para: `Russisch ist eine der meistgesprochenen Sprachen der Welt. Zusammen mit Englisch und Chinesisch ist es eine der Sprachen, die sich ständig erweitern und eine ständig wachsende Zahl von Menschen betreffen. Unternehmen mit dem Wunsch nach Wachstum können die Hilfe eines Russisch-Dolmetschers, der an Simultandolmetschen gewöhnt ist, äußerst nützlich finden. Diejenigen, die Kongresse, Remote-Meetings und internationale Meetings leiten, benötigen möglicherweise einen funktionalen und schnellen Remote-Dolmetscherdienst für Russisch. Auf Rafiky können Sie Ihren zukünftigen professionellen Dolmetscher aus dem Italienischen ins Russische auswählen, der Ihrem Unternehmen hilft, Tag für Tag zu wachsen.`,
  russianItalian_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Russian interpreter
  russianInterpreter_Heading: `So wählen Sie Ihren eigenen professionellen Russisch-Dolmetscher aus`,
  russianInterpreter_para: `Wenn Sie sich fragen, wie Sie den besten Italienisch-Russisch-Dolmetscherdienst auswählen können, sind Sie bei uns genau richtig. Wir von Rafiky können die Vorteile unseres Webkonferenzsystems mit russischem Dolmetscher auflisten, die Vorteile, die Ihr Unternehmen aus einer zukünftigen Zusammenarbeit ziehen könnte. Sie hätten nicht nur sofortigen Zugang zu einem erfahrenen und sachkundigen Russisch-Dolmetscher, der Ihnen bei der Lösung unerwarteter Probleme helfen kann, sondern Sie könnten auch aus der Ferne Unterstützung anfordern. Unser Ferndolmetschsystem für Russisch tut genau das, um die Kommunikation zwischen Kunde und Dolmetscher zu beschleunigen. Bringen Sie Ihr Unternehmen auf ein neues Level und steigern Sie die Verkaufskraft Ihres Unternehmens. Wählen Sie den besten professionellen Dolmetscher aus dem Italienischen ins Russische auf Rafiky!`,
  ...
  estimateRates_BtnHeading: `Benötigen Sie Dolmetscher?`,
  estimateRates_Btn: `Nächste`,
  qa: "Fragen & Antworten",
  //Rafiky Prices
  rafikyPrices_Heading: `RAFIKY-PREISE DER DIENSTLEISTUNGEN`,
  rafikyPrices_para: `Wir haben weltweit die wettbewerbsfähigsten Preise auf dem Markt! Kontaktieren Sie uns jetzt, um die Vorteile für unsere neuen Kunden zu entdecken, und vergessen Sie nicht, eine kostenlose Demo anzufordern.`,
  rafikyPrices_FirstcardHeading: `Silber`,
  rafikyPrices_FirstcardSubHeading: `299/Monat`,
  rafikyPrices_Firstcardpara: ` Jährliche Abrechnung Bis zu 100 Teilnehmer pro Veranstaltung`,
  rafikyPrices_FirstcardBtn: `KAUFE JETZT`,
  rafikyPrices_SeccardHeading: `Gold`,
  rafikyPrices_SeccardSubHeading: `499/Monat`,
  rafikyPrices_Seccardpara: ` Jährliche Abrechnung Bis zu 500 Teilnehmer pro Veranstaltung`,
  rafikyPrices_SeccardBtn: `KAUFE JETZT`,
  rafikyPrices_ThirdcardHeading: `Platin`,
  rafikyPrices_ThirdcardSubHeading: `699/Monat`,
  rafikyPrices_Thirdcardpara: ` Jährliche Abrechnung Bis zu 5000 Teilnehmer pro Veranstaltung`,
  rafikyPrices_ThirdcardBtn: `KAUFE JETZT`,
  //Subscription Categories
  subscriptionCategories_OneHeading: `Abonnement`,
  subscriptionCategories_FirstSubHeading: `Plattform kompatibel mit allen Geräten`,
  subscriptionCategories_FirstSubHeadingpara: `Kompatibilität mit den gängigsten Geräten (Smartphones / Tablets).`,
  subscriptionCategories_SecSubHeading: `HD-Video - Web-Audio`,
  subscriptionCategories_SecSubHeadingpara: `Super hochwertiges Video, kristallklares Audio, keine Interferenzen`,
  subscriptionCategories_ThirdSubHeading: `Branding-Anpassung`,
  subscriptionCategories_ThirdSubHeadingpara: `Branding-Anpassung Möglichkeit, Ihre eigene Logo-Agenda und Beschreibungen auf den Webseiten zu verwenden, die der Veranstaltung gewidmet sind`,
  subscriptionCategories_ForthSubHeading: `Kompatibilität mit allen Webkonferenz-Programmen`,
  subscriptionCategories_ForthSubHeadingpara: `Integration mit anderen Plattformen (GoToMeeting MS Team Webex etc.)`,
  subscriptionCategories_FifthtSubHeading: `Direkter Zugriff für jeden Benutzer`,
  subscriptionCategories_FifthSubHeadingpara: `Generierter Link, auf den der Benutzer zugreifen kann, indem er die Besprechungs-ID und den Namen eingibt`,
  subscriptionCategories_SixthSubHeading: `Chat-Räume`,
  subscriptionCategories_SixthSubHeadingpara: `Fähigkeit zur öffentlichen/privaten Kommunikation in verschiedenen Räumen`,
  subscriptionCategories_SeventhSubHeading: `Mobile Apps`,
  subscriptionCategories_SeventhSubHeadingpara: `Laden Sie einfach die Anwendung Rafiky Connect (aus dem App Store oder Google Play) auf Ihr Gerät herunter, wählen Sie die gewünschte Sprache und hören Sie sich die Konferenz an`,
  subscriptionCategories_EightSubHeading: `PPT-Uploads`,
  subscriptionCategories_EightSubHeadingpara: `Möglichkeit zum Hochladen von Powerpoint-Präsentationen innerhalb von Videoanrufen in einem einfachen und intuitiven Seiten-Scrolling-System`,
  subscriptionCategories_NineSubHeading: `Video-Uploads`,
  subscriptionCategories_NineSubHeadingpara: `Möglichkeit, hochauflösende Videos innerhalb von Videoanrufen hochzuladen`,
  subscriptionCategories_TenthtSubHeading: `Inhalte der Benutzeroberfläche in mehr als 60 Sprachen übersetzt NEU!`,
  subscriptionCategories_TenthSubHeadingpara: `(statisch und dynamisch (Chat und Power Point)`,
  subscriptionCategories_EleventhtSubHeading: `Info-Lautsprecher NEU!`,
  subscriptionCategories_EleventhSubHeadingpara: `Lautsprechergurt mit Name Nachname Position und Firmenlogo`,
  subscriptionCategories_TwelvelSubHeading: `Lautsprechertimer NEU!`,
  subscriptionCategories_TwelvelSubHeadingpara: `Möglichkeit für den Redner, die (vom Moderator zugewiesene) Zeit zu "sehen", die ihm für die Intervention zur Verfügung steht`,
  subscriptionCategories_ThirteenSubHeading: `Virtuelles Abstimmungssystem`,
  subscriptionCategories_ThirteenSubHeadingpara: `Virtuelles Abstimmungssystem Erstellung und Präsentation von Quizzes und Fragebögen. Der Moderator stellt die Fragen und erhält die Antworten`,
  subscriptionCategories_FourteenSubHeading: `1 GB Cloud-Aufzeichnung (pro Lizenz) und/oder lokal`,
  subscriptionCategories_FourteenSubHeadingpara: `1 GB verfügbarer Speicherplatz für jede Lizenz`,
  subscriptionCategories_FifteenSubHeading: `Berichterstattung nach der Veranstaltung`,
  subscriptionCategories_FifteenSubHeadingpara: `Technischer Bericht mit: Statistik der Teilnehmer (Verbindungsdauer zum Konferenzverbindungsnetz während der Veranstaltung) Antwort des Abstimmungssystems mit Prozentangaben`,
  subscriptionCategories_SixteenSubHeading: `Personalisierte E-Mails`,
  subscriptionCategories_SixteenSubHeadingpara: `Fachbericht mit: Einladung an die Teilnehmer mit Zugangsdaten. Personalisierte E-Mail mit Kundenlogo`,
  subscriptionCategories_SeventeenSubHeading: `Mehrsprachige Audioaufnahme`,
  subscriptionCategories_SeventeenSubHeadingpara: `Möglichkeit, den Ton der Konferenz in den verschiedenen beteiligten Sprachen aufzuzeichnen`,
  subscriptionCategories_EighteenSubHeading: `Gebärdensprach-Videobox NEU!`,
  subscriptionCategories_EighteenSubHeadingpara: `Echtzeit-Videofenster mit Zeicheninterpreter`,
  subscriptionCategories_NineteenSubHeading: `Breakout-Räume`,
  subscriptionCategories_NineteenSubHeadingpara: `Möglichkeit, einen Plenarsaal + andere Räume parallel in Bezug auf die Themen Ihrer Veranstaltung zu organisieren`,
  subscriptionCategories_TwentySubHeading: `Stream-Out-Service NEU!`,
  subscriptionCategories_TwentySubHeadingpara: `Online-Streaming mit vollständiger Branding-Anpassung, Berichterstellung aller Teilnehmer, personalisierter Chat und vieles mehr!`,
  subscriptionCategories_TwentyoneSubHeading: `Social-Media-Streaming`,
  subscriptionCategories_TwentyoneSubHeadingpara: `Möglichkeit, die Veranstaltung in Echtzeit aufzuzeichnen und an eine unbegrenzte Anzahl von Zuschauern zu übertragen (Facebook Live Youtube …)`,
  subscriptionCategories_TwentytwoSubHeading: `Virtuelle Hostessen/Stewards`,
  subscriptionCategories_TwentytwoSubHeadingpara: `Kommunizieren Sie auf innovative Weise, indem Sie Ihre Inhalte durch Nachrichten personalisieren, die von virtuellen Hostessen/Stewards gesendet werden`,
  subscriptionCategories_TwentythreeSubHeading: `Zahlungsannahme`,
  subscriptionCategories_TwentythreeSubHeadingpara: `Möglichkeit, Zahlungen von Veranstaltungsteilnehmern abzubuchen`,
  subscriptionCategories_TwentyfourSubHeading: `eigene URL`,
  subscriptionCategories_TwentyfourSubHeadingpara: `Möglichkeit, Kanäle mit einer benutzerdefinierten URL abzugleichen`,
  subscriptionCategories_TwentyfiveSubHeading: `Teilnahmebescheinigungen`,
  subscriptionCategories_TwentyfiveSubHeadingpara: `Möglichkeit zur Erstellung und Ausstellung von Teilnahmezertifikaten für Veranstaltungsteilnehmer`,
  subscriptionCategories_TwentysixSubHeading: `Simultane Interpretation`,
  subscriptionCategories_TwentysixSubHeadingpara: `Mehrsprachige Konferenz mit bis zu 50 Dolmetscherkanälen parallel`,
  subscriptionCategories_TwoHeading: `Platin`,
  subscriptionCategories_ThreeHeading: `Gold`,
  subscriptionCategories_FourHeading: `Silber`,
  //Choose Rafiky
  chooseRafiky_Title: `Warum Rafiky wählen?`,
  chooseRafiky_Firstcard_Heading: `Bester Preis`,
  chooseRafiky_Firstcard_Headingpara: `Für den gleichen Service bieten wir unseren Partnern die besten Preise auf dem Markt.`,
  chooseRafiky_Firstcard_Heading: `SUPER BENUTZERFREUNDLICH!`,
  chooseRafiky_Firstcard_Headingpara: `Laden Sie unsere Anwendung herunter und sehen Sie den Erfolg Ihrer Veranstaltungen und Meetings.`,
  chooseRafiky_Firstcard_Heading: `Schulung & Zertifizierung`,
  chooseRafiky_Firstcard_Headingpara: `Wir bieten allen unseren Mitarbeitern spezifische Schulungen mit abschließender Zertifizierung auf der Grundlage der erreichten Niveaus.`,
  chooseRafiky_Firstcard_Heading: `Audio- und Videoqualität`,
  chooseRafiky_Firstcard_Headingpara: `Unsere Plattform wurde unter Verwendung der besten Qualitätsstandards in Bezug auf die Leistung der Audio-/Videoqualität entwickelt.`,
  chooseRafiky_Firstcard_Heading: `INNOVATIVE VISION`,
  chooseRafiky_Firstcard_Headingpara: `Treten Sie dem Netzwerk technologisch fortschrittlicher Unternehmen bei, die einzigartige Lösungen anbieten können.`,
  chooseRafiky_Firstcard_Heading: `BARRIEREFREIHEIT`,
  chooseRafiky_Firstcard_Headingpara: `Von überall aus war der Zugriff auf unsere Software/App noch nie so einfach.`,
  chooseRafiky_Firstcard_Heading: `Verfügbarkeit 24/24 - 7/7 `,
  chooseRafiky_Firstcard_Headingpara: `Dank unserer Büros in verschiedenen Teilen der Welt ist unser Team 7 Tage die Woche 24 Stunden am Tag verfügbar. `,
  chooseRafiky_Firstcard_Heading: `+ Als 200 Sprachen`,
  chooseRafiky_Firstcard_Headingpara: `Wir können Ihrem Publikum jederzeit und überall bis zu 200 Sprachen anbieten!`,
  //Questions Answers
  questionsAnswers_Headingone: `Fragen & Antworten`,
  questionsAnswers_FirstSubheading: `Wie funktioniert Rafi?`,
  questionsAnswers_FirstSubheadingpara: `Auf unserer Plattform wird zum ersten Mal in Italien ein Konto erstellt, das von uns sowohl für Kunden als auch für Dolmetscher vollständig entwickelt wurde, dann kann der Kunde die Konferenz, an der er teilnehmen möchte, und die Zuhörsprache auswählen, und das war's! Das Spiel ist fertig!`,
  questionsAnswers_SecSubheading: `Für welche Sprachkombinationen?`,
  questionsAnswers_SecSubheadingpara: `Wir übersetzen aus und in mehr als 200 Sprachen dank unserer 6000 Dolmetscher, die wir sorgfältig ausgewählt haben und weiterhin auswählen, um den besten Dolmetschdienst der Branche zu gewährleisten. Wir sind auch in mehr als 60 Ländern sowohl im öffentlichen als auch im privaten Sektor verfügbar.`,
  questionsAnswers_ThirdSubheading: `Was sind die Kosteneinsparungen mit Rafiky?`,
  questionsAnswers_ThirdSubheadingpara: `Wir reduzieren die Dolmetschkosten um ca. 80 Prozent.`,
  questionsAnswers_ForthSubheading: `Welche Systeme werden für den Datenschutz verwendet?`,
  questionsAnswers_ForthSubheadingpara: `Wir verwenden die sichersten Server auf dem Markt, was sehr wichtig ist, wenn es um Konferenzen geht, die einen gewissen Datenschutzstandard erfordern.`,
  questionsAnswers_FifthSubheading: `Ermöglicht die Plattform die Dateifreigabe sowie die Bildschirmfreigabe während der Veranstaltung? Ist es auch möglich, einzelne Sessions aufzuzeichnen?`,
  questionsAnswers_FifthSubheadingpara: `Ja, die Plattform ermöglicht Ihnen sowohl die Bildschirmfreigabe als auch die Datei- und Präsentationsfreigabe. Es ist dann möglich, sowohl die originale Video- als auch die Audioaufzeichnung in allen Sprachen zu machen, für die wir während der Konferenz gedolmetscht haben. Sie erfordern zusätzliche Kosten, die wir natürlich in der Kalkulationsphase hinzufügen.`,
  questionsAnswers_SixthSubheading: `Stehen Ihnen bei Sonderwünschen rund um die Uhr Dolmetscher zur Verfügung?`,
  questionsAnswers_SixthSubheading: `Eine Veranstaltung hat mehrere Konferenzen in mehreren Räumen. Ist es möglich, Rafiky zu verwenden?`,
  questionsAnswers_SevenSubheadingpara: `Sicherlich! Genau das ist einer der Fälle, in denen es besonders teuer ist, Kabinen in verschiedenen Räumen einzusetzen. Mit Rafiky reicht es aus, in jedem Zimmer einen Computer mit Internetanschluss aufzustellen.`,
  questionsAnswers_SevenSubheading: `Wenn der Kunde seine eigenen Dolmetscher einsetzen möchte, bieten Sie spezielle Schulungen an?`,
  questionsAnswers_EightSubheadingpara: `Absolut ja und vor allem ohne Aufpreis!`,
  questionsAnswers_EightSubheading: `Was ist, wenn an dem Ort, an dem ich Rafiky verwenden möchte, keine Internetverbindung besteht?`,
  questionsAnswers_NineSubheadingpara: `Wir arbeiten mit Unternehmen zusammen, die sich ebenfalls damit befassen, um den Service überall problemlos gewährleisten zu können.`,
  questionsAnswers_NinetSubheading: `Was wäre, wenn die Veranstaltungsteilnehmer keine eigenen Kopfhörer hätten?`,
  questionsAnswers_TenthtSubheadingpara: `In Absprache mit dem Organisator der Veranstaltung können wir Einweg-Ohrhörer, Kopfhörer und Powerbanks / Backup-Backup-Batterien zur Verfügung stellen, damit sie bei Bedarf im Publikum bequem am Veranstaltungsort angefordert werden können. `,
  questionsAnswers_TenthSubheading: `Ist die Anzahl der Zugriffe auf die Plattform unbegrenzt? `,
  questionsAnswers_ElevenSubheadingpara: `Die Anzahl der Zugänge ist entsprechend dem Abo-Paket begrenzt.`,
  questionsAnswers_ElevenSubheading: `Handelt es sich bei der technischen Unterstützung um eine kontinuierliche Überwachung oder sehen Sie eine andere Unterstützungsmethode vor? Welche Rolle spielt der Techniker?`,
  questionsAnswers_FirstSubheadingpara: `Die Rolle unserer Techniker besteht darin, durch kontinuierliche Überwachung sicherzustellen, dass die Veranstaltung optimal abläuft. Sowohl beim Dolmetschen als auch beim Publikum im Saal entpuppt er sich als echter Überwacher.`,
  questionsAnswers_Btn: `STELLE EINE FRAGE`,
  questionsAnswers_HeaingTwo: `VERWENDEN SIE DIE BESTE ÜBERSETZUNGSTECHNOLOGIE DER WELT`,
  questionsAnswers_HeaingTwoBtn: `FORDERN SIE EIN SCHNELLES ANGEBOT AN`,
  //Who We Are
  whoWeAre_Title: `WER WIR SIND`,
  whoWeAre_SubTitle: `Remote-Simultanübersetzung. Wir verändern die Welt.`,
  whoWeAre_SubTitlepara: `Die Vergangenheit liegt hinter uns! Wir verändern die Art und Weise, wie wir das Dolmetschen sehen. Dank einer von uns erstellten Software haben wir jede Sprachbarriere überwunden. Rafiky und unser Team repräsentieren die Innovation eines Dienstleistungssektors, der es Ihnen ermöglicht, mit Menschen aus der ganzen Welt zu kommunizieren: Simultandolmetschen per Fernzugriff.`,
  whoWeAre_Btnone: `EINFÜHRUNG ANSEHEN`,
  whoWeAre_Btntwo: `Buchen Sie ein Treffen`,
  //Our Mission
  ourMission_Heading: `Unsere Aufgabe`,
  ourMission_para: `Nur 17 % der Welt sprechen Englisch als Mutter- oder Zweitsprache. Wenn es jedoch um professionelle Meetings und Veranstaltungen geht, ist Englisch oft immer noch die Standardsprache. Das wollen wir ändern. Die Welt in ihrer Sprache verbinden.`,
...
Rafiky ermöglicht die Nutzung der Remote-Simultandolmetschen (RSI) ganz einfach über Smartphones, Tablets oder Computer, in jeder Sprache und in Echtzeit. Dabei werden die Kosten reduziert und die Exzellenz eines durchgehend hochwertigen Services gewährleistet, ganz wie bei der traditionellen Dolmetschung, jedoch ohne die sperrigen Übersetzungskabinen und die damit verbundenen Kosten und Zeitaufwände für Aufbau und Abbau.`,
  ...
  howDoes_para: `Remote-Videodolmetschen, was ist das und wie funktioniert es? Erfahren Sie mehr über unseren Ferndolmetsch-Service!`,
  ...
  ready_Btn: `FORDERN SIE JETZT EIN ANGEBOT AN`,
  //Use Cases
  useCases_Title: `Entfesseln Sie die Kraft des Ferndolmetschens für Ihre Veranstaltung!`,
  ...
  microsoftTeams_FirstcardHeading: `KONFERENZEN`,
  microsoftTeams_Firstcardpara: `Vertrauen Sie Rafiky für Ihre Konferenz. Dank unserer Technologie bieten wir einen schnellen und bequemen Service, der den Teilnehmern das beste Erlebnis garantiert, ohne dass sperrige Kabinen im Raum erforderlich sind.`,
  microsoftTeams_SeccardHeading: `PRESSEKONFERENZ`,
  microsoftTeams_Seccardpara: `Mit der Plattform von Rafiky können Sie während Ihrer Pressekonferenz professionelles Simultandolmetschen für beliebig viele Sprachen anbieten, ohne im Voraus Kabinen bestellen oder Dolmetscher buchen zu müssen. Alles, was es braucht, ist ein paar Stunden im Voraus.`,
  microsoftTeams_ThirdHeading: `WEBINARE`,
  microsoftTeams_Thirdpara: `Rafiky bietet dem Benutzer die Möglichkeit, das Publikum von Webinaren mit einem mehrsprachigen Publikum zu erhöhen. Alle Teilnehmer können während der Veranstaltung ohne Kommunikationsschwierigkeiten interagieren: Es ist diese Art von Flexibilität, die Rafiky in seiner Art einzigartig macht.`,
  microsoftTeams_ForthHeading: `WORKSHOPS & SCHULUNGEN`,
  microsoftTeams_Forthpara: `Durch den Einsatz von Rafiky werden Sie feststellen, dass jedes Workshop-Training einem internationalen Publikum angeboten werden kann. Live-Übersetzungen werden mit dieser leistungsstarken Anwendung zum Kinderspiel.!`,
  microsoftTeams_FiveHeading: `UNTERNEHMENSTAGUNGEN`,
  microsoftTeams_Fivepara: `Nichts ist für Führungskräfte frustrierender, als bei Firmenmeetings mit Sprachbarrieren konfrontiert zu werden. Bei diesen Gelegenheiten ist eine einfache Kommunikation unerlässlich: Dank der Verwendung von Rafiky gehören Kommunikationsschwierigkeiten der Vergangenheit an!`,
  microsoftTeams_SixHeading: `ONLINE-MEETINGS`,
  microsoftTeams_Sixpara: `Last-Minute-Online-Meetings und Videokonferenzen? Rafiky wurde dafür entwickelt! Dank Ferndolmetschen werden die besten Ferndolmetscher in Echtzeit mit Rednern und Teilnehmern verbunden.`,
  microsoftTeams_SevenHeading: `MUSEEN & FÜHRUNGEN`,
  microsoftTeams_Sevenpara: `Für Museumsbesuche oder jede Art von Tour kann sich jeder Teilnehmer mit Rafiky verbinden und Live-Dolmetschen erhalten: Auf diese Weise fühlt sich niemand während der Tour ausgeschlossen, was zu einer angenehmen Gelegenheit zum Teilen wird.`,
  microsoftTeams_EightHeading: `AUSSTELLUNGEN UND MESSEN`,
  microsoftTeams_Eightpara: `Besuchen Sie eine Messe im Ausland oder veranstalten Sie eine Ausstellung? Selbst für diese Art von Bedarf ist Rafiky die funktionellste und… taschengroße Lösung!`,
  microsoftTeams_Btn: `FINDE MEHR HERAUS`,
  //Lets Begin
  letsBegin_Title: `LASS UNS ANFANGEN`,
  letsBegin_SubTitle: `Bereit für eine echte Veränderung? Lassen Sie es uns gemeinsam angehen!`,
  letsBegin_Btn: `FORDERN SIE EIN ANGEBOT AN`,
  //Contact Us
  contactUs_Title: `Wir sind für Sie da!`,
  contactUs_SubTitle: `Rafiky-Kontakte`,
  contactUs_para: `Unser Team beantwortet gerne Ihre Anfragen. Füllen Sie das Formular aus und wir werden Sie in 15 Minuten kontaktieren!`,
  contactUs_FirstcardHeading: `Adresse`,
  contactUs_Firstcardpara: `Viale Fulvio Testi 59 Mailand 20158 Italien`,
  contactUs_SeccardHeading: `Kontaktiere uns`,
  contactUs_Seccardpara: `info@rafiky.net +39 0282950332`,
  contactUs_ThirdcardHeading: `Öffnungszeit`,
  contactUs_Thirdcardpara: `Mo-Fr: 8:00-18:00 Sa-So: 8:00-13:00`,
  //Request Demo
  requestDemo_Heading: `Eine Demo anfordern`,
  requestDemo_Firstline: `Name`,
  requestDemo_Secline: `Email`,
  requestDemo_Thirdline: `Nachrichtenname`,
  requestDemo_Btn: `ANGEBOTE ERHALTEN`,
  //FAQs
  FAQs_Heading: `RAFIKY-FAQ`,
  ContactUsTitle: "Kontaktieren Sie uns",
  ContactUsFooterPara: "Revolutionieren Sie Ihre Veranstaltung mit Rafiky!",
  //Technical Equipment
  technicalEquipment_Title: `Technisches Equipment`,
  technicalEquipment_FirstSubTitle: `Technisches Equipment`,
  technicalEquipment_FirstSubTitlepara: `Welche Art von Hardware benötige ich, um Rafiky zu verwenden? Gibt es besondere Anforderungen, um Rafiky von einem Mobiltelefon aus zu verwenden? Benötige ich das neueste Update oder eine bestimmte Version? Benötige ich professionelle Mikrofone? Welche Art von Ausrüstung benötigen Dolmetscher, um die Audioqualität der Dolmetschung zu optimieren? Gibt es eine Volumenbegrenzung? Und wie kann ich es möglicherweise erhöhen? Was ist, wenn einer der Teilnehmer kein Handy hat oder es nicht benutzen kann? Was ist, wenn Teilnehmer ihre Kopfhörer vergessen? Kann das verwendete Equipment die Tonqualität beeinflussen?`,
  technicalEquipment_SecSubTitle: `Welche Art von Hardware benötige ich, um Rafiky zu verwenden?`,
  technicalEquipment_SecSubTitlepara: `Um Rafiky verwenden zu können, benötigen Sie: Computer, Laptop, Telefon oder Tablet, das vorzugsweise über ein LAN-Kabel (Ethernet) mit dem Internet verbunden ist. Webcam mit dem Gerät verbunden oder integriert. Darüber hinaus wird die Verwendung von Kopfhörern und Mikrofonen dringend empfohlen. Gibt es besondere Anforderungen, um Rafiky von einem Mobiltelefon aus zu verwenden? Benötige ich das neueste Update oder eine bestimmte Version? No Rafiky kann auf iPhones ab iOS 8.0 und auf allen Android-Geräten ab Version 4 verwendet werden. Wir empfehlen jedoch, sich an die erwarteten Updates des Betriebssystems zu halten.`,
  technicalEquipment_ThreeSubTitle: `Benötige ich professionelle Mikrofone?`,
  technicalEquipment_ThreeSubTitlepara: `Keine professionellen Mikrofone sind nicht erforderlich. Wir raten jedoch, Pre-Event-Checks durchzuführen, um deren Empfang und Wirksamkeit im Vorfeld zu überprüfen.`,
  technicalEquipment_FourSubTitle: `Welche Art von Ausrüstung benötigen Dolmetscher, um die Audioqualität der Dolmetschung zu optimieren?`,
  technicalEquipment_FourSubTitlepara: `Dolmetscher benötigen professionelles Equipment inklusive Mikrofon und Eingabesystem. Im Einzelnen empfehlen wir folgende Modelle: Profi-Mikrofone: Shure sm58s Sennheiser e835s mit Shure X2U-Adaptern (für hochwertigen Sound) oder einem einfachen USB-zu-XLR-Kabel. HiEnd-Headsets Logitech H650e Logitech H820e (nur drahtlos) Plantronics Blackwire 520 Plantronics Blackwire 725 Jabra BIZ 2400 Serie II.`,
  //Internet WiFi
  internetWifi_FirstSubTitle: `Internet und WLAN`,
  internetWifi_FirstSubTitlepara: `Gibt es spezielle Netzwerkanforderungen? Gibt es einen Mindestabstand zu Rednern, den die Teilnehmer einhalten müssen, um die Übersetzung auf ihren Geräten zu hören? Gibt es spezielle WLAN-Anforderungen? Gibt es eine maximale Anzahl von Personen, die sich über Wi-Fi mit einer Sendung verbinden können? Kann ich mehrere WLAN-Hotspots nutzen, um eine WLAN-Überfüllung zu vermeiden? Wie viele MB werden pro Benutzer und Stunde verbraucht? Was ist, wenn ich während des Streamens meine Internetverbindung verliere? Welche WLAN-Netzwerkgeräte empfiehlt Rafiky?`,
  internetWifi_SecSubTitle: `Gibt es spezielle Netzwerkanforderungen?`,
  internetWifi_SecSubTitlepara: `Ja. Um sich mit der Konferenz zu verbinden, müssen Sie mindestens 4/6 Mbit/s Up- und Download-Internetgeschwindigkeit haben. Eine kabelgebundene Verbindung mit einem LAN-Kabel (Ethernet) wird ebenfalls empfohlen.`,
  internetWifi_ThreeSubTitle: `Gibt es einen Mindestabstand (zu den Sprechern) für Teilnehmer, die die Übersetzung auf ihren Geräten hören möchten?`,
  internetWifi_ThreeSubTitlepara: `Nein. In Bezug auf die WLAN-Verbindung können sich die Teilnehmer frei bewegen, während sie der Übersetzung lauschen. Sie können optional auf mobile Daten (3G / 4G / LTE) wechseln, um den Stream von überall am Standort zu hören. `,
  internetWifi_FourSubTitle: `Wie viele Personen können sich maximal über WLAN mit einer Sendung verbinden? `,
  internetWifi_FourSubTitlepara: `Das Rafiky-System kann bis zu 50000 Zuhörer unterstützen. Diese Nummer hängt jedoch auch von den Fähigkeiten Ihres lokalen Netzwerks ab.`,
  internetWifi_FiveSubTitle: `Kann ich mehrere WLAN-Hotspots verwenden, um eine WLAN-Überlastung zu vermeiden?`,
  internetWifi_FiveSubTitlepara: `Ja, Sie können mehrere WLAN-Hotspots verwenden, aber sie müssen alle mit demselben Netzwerk verbunden sein.`,
  ...
  capacityFeatures_ThreeSubTitle: `Kann die Konferenz aufgezeichnet werden?`,
  capacityFeatures_ThreeSubTitlepara: `Ja, teilen Sie es einfach im Voraus mit.`,
  capacityFeatures_FourSubTitle: `Ist es möglich, die Übersetzung vorab aufzunehmen und dann während der Veranstaltung zu streamen?`,
  capacityFeatures_FourSubTitlepara: `Ja, auch in diesem Fall muss dies im Voraus mitgeteilt werden und die aufgezeichnete Übersetzung kann während der Veranstaltung angehört werden. Internetnutzung (wenn Online-Streaming aktiviert ist):`,
  capacityFeatures_FiveSubTitle: `Wie ist die Audioqualität?`,
  capacityFeatures_FiveSubTitlepara: `Wir verwenden OPUS Codec für die Audiokomprimierung. Der Sender hat die folgenden Optionen: Niedrig: 32 kbit/s Breitbandsprache Normal: 64 kbit/s Mono-Breitband Musik Audiobandbreite 20 kHz Abtastrate 48 kHz Hoch: 128 kbit/s Mono Musik Breitband 20 kHz Audiobandbreite 48 kHz Abtastrate`,
  //App
  app_FirstSubTitle: `App`,
  app_FirstSubTitlepara: `Videoanleitung für den Hörer: Android Videoanleitung für den Hörer: iOS Wie viel Strom verbraucht die App aus dem Akku des Telefons? Was ist, wenn mich jemand anruft, während ich den Audiostream anhöre? Wird die App geschlossen, wenn ich eine Nachricht sende oder im Internet surfe, während ich den Audiostream anhöre? Wenn ich die App öffne, steht da „Keine Termine geplant“. Warum? Ist es möglich, über die App Feedback von Teilnehmern zu sammeln?`,
  app_SecSubTitle: `Videoanweisungen für Android-Listener`,
  app_SecSubTitlepara: `Sehen Sie sich unser Video-Tutorial an!`,
  app_ThreeSubTitle: `Videoanweisungen für iOS-Listener`,
  app_ThreeSubTitlepara: `Sehen Sie sich unser Video-Tutorial an!`,
  app_FourSubTitle: `Wie viel Akkuleistung verbraucht die Rafiky-App?`,
  app_FourSubTitlepara: `Die App verbraucht etwa 4-8 % Ihres Akkus pro Stunde.`,
  app_FiveSubTitle: `Was ist, wenn mich jemand anruft, während ich den Audiostream anhöre?`,
  app_FiveSubTitlepara: `Das Streaming wird während des Anrufs angehalten (auch WhatsApp Viber usw.). Danach können Sie zur App zurückkehren und dort weitermachen, wo Sie aufgehört haben.`,
  app_SixSubTitle: `Wird die Rafiky-App geschlossen, wenn ich eine Nachricht sende oder im Internet surfe, während ich den Audiostream anhöre?`,
  app_SixSubTitlepara: `Nein, die Rafiky-App bleibt aktiv. Sie können die Veranstaltung bequem mit anderen Anwendungen in Ihrem Handy anhören. `,
  internetWifi_SevenSubTitle: `Wenn ich die App öffne, steht da „Keine Termine geplant“. Warum?`,
  internetWifi_SevenSubTitlepara: `Die Meldung „Keine geplanten Ereignisse“ wird angezeigt, wenn: - Es keine geplanten Ereignisse gibt Ihr Telefon mit einem anderen Wi-Fi-Netzwerk verbunden ist als Ihr Computer Die Computer-App noch nicht geöffnet ist Keine Internetverbindung`,
  //Participants
  participants_FirstSubTitle: `Teilnehmer`,
  participants_FirstSubTitlepara: `Wie kommen Teilnehmer mit Rafiky in Kontakt? Ich habe das Ereignis gestartet, aber die Lautstärke ist zu niedrig. Wie kann ich? Ich habe mich bei der Veranstaltung angemeldet, aber ich höre nichts. Wie kann ich das beheben? Mein Mikrofon und meine Webcam funktionieren nicht. Was muss ich tun? Was mache ich, wenn ich die Übersetzung nicht hören kann? Ich möchte dem Berichterstatter eine Frage stellen. Wie interveniere ich? Wie kontaktiere ich den technischen Support, während ich mit dem Event verbunden bin? Wie viele Sprachoptionen kann die App gleichzeitig unterstützen? Was kann ich tun, wenn ich auf technische Probleme stoße? Gibt es einen Mindestabstand zu den Rednern für Teilnehmer, die die Übersetzung von ihren Geräten hören möchten? Was ist, wenn mich jemand anruft, während ich den Audiostream anhöre? Wird die App geschlossen, wenn ich eine Nachricht sende oder im Internet surfe, während ich Audio höre? Ist es möglich, über die App Feedback von Teilnehmern zu sammeln?`,
  participants_SecSubTitle: `Wie kommen Teilnehmer mit Rafiky in Kontakt?`,
  participants_SecSubTitlepara: `elektronisch: durch Versenden einer E-Mail an alle Teilnehmer einige Tage vor der Veranstaltung, in der die Teilnehmer über die Organisation der Veranstaltung informiert werden Rafiky-Plattform Sprachen usw. Zum Zeitpunkt der Registrierung stellt Rafiky sogar E-Mail-Vorlagen, PPT-Materialien und Flyer in allen Sprachen zur Verfügung, um eine vollständige Kommunikation sicherzustellen alle Teilnehmer.`,
  participants_ThreeSubTitle: `Ich habe das Ereignis gestartet, aber die Lautstärke ist zu niedrig. Wie kann ich? `,
  participants_ThreeSubTitlepara: `Bei geringer Lautstärke wird der Teilnehmer gebeten, die Lautstärkeausgabe der Computerperipherie zu überprüfen.`,
  participants_FourSubTitle: `Ich habe mich bei der Veranstaltung angemeldet, aber ich höre nichts. Wie kann ich das beheben?`,
  participants_FourSubTitlepara: `Erhöhen Sie den Lautstärkeregler rechts neben dem „Original“-Feld, indem Sie ihn nach außen ziehen. Wenn das Problem weiterhin besteht, aktualisieren Sie die Seite bitte mit der Schaltfläche oben rechts.`,
  participants_FiveSubTitle: `Mein Mikrofon und meine Webcam funktionieren nicht. Wie kann ich? `,
  participants_FiveSubTitlepara: `Sie können Ihre Mikrofon- und Webcam-Geräte über die Zahnradschaltfläche oben rechts auswählen.`,
  participants_SixSubTitle: `Was mache ich, wenn ich die Übersetzung nicht hören kann?`,
  participants_SixSubTitlepara: `Sie müssen die Übersetzung in der von Ihnen bevorzugten Sprache aus dem Dropdown-Menü auswählen, indem Sie oben auf die Schaltfläche "DOLMETSCHEN" klicken. Wir erinnern Sie auch daran, dass Sie mit den Schiebereglern entscheiden können, ob Sie sich die Übersetzung und/oder die Originalsprache anhören möchten.`,
  participants_FourSubTitle: `Ich möchte dem Berichterstatter eine Frage stellen. Wie interveniere ich?`,
  participants_FourSubTitlepara: `Wir erinnern alle freundlichen Teilnehmer daran, dass Sie Ihre Fragen hinterlegen können, indem Sie den Redner im entsprechenden Abschnitt erwähnen, Chat auswählen, auf „An“ klicken und auf Fragen & Antworten klicken.`,
  participants_FiveSubTitle: `Wie kontaktiere ich den technischen Support, während ich mit dem Event verbunden bin?`,
  participants_FiveSubTitlepara: `Bei technischen Problemen schreiben Sie bitte per Chat an den technischen Support, wählen Sie Chat, drücken Sie auf „An“ und wählen Sie dann den Abschnitt „Technischer Support“.`,
  participants_SixSubTitle: `Was kann ich tun, wenn ich auf technische Probleme stoße?`,
  participants_SixSubTitlepara: `Bei technischen Problemen empfehlen wir Ihnen, die Seite zu aktualisieren, indem Sie auf die vorletzte Schaltfläche rechts im oberen Bereich „Seite aktualisieren“ klicken.`,
  participants_SevenSubTitle: `Gibt es einen Mindestabstand (zu den Sprechern) für Teilnehmer, die die Übersetzung von ihren Geräten hören möchten?`,
  participants_SevenSubTitlepara: `Die Zuhörer können so weit von der Bühne entfernt sein, wie die Wi-Fi-Verbindung reicht. Sie können sich frei bewegen, zum Parkplatz gehen und gleichzeitig die Übersetzung über WLAN oder mobile Daten (3G / 4G / LTE) anhören.`,
  //Interpreters
  interpreters_FirstSubTitle: `Dolmetscher`,
  interpreters_FirstSubTitlepara: `Wen soll ich anschreiben, um mich für das Simulations-Webinar anzumelden? Bekomme ich nach diesem Webinar eine Rafiky-Zertifizierung? Übersetzt die Rafiky-Anwendung Audio? Welche Bandbreite wird benötigt? Wie funktioniert die Integration mit Microsoft Teams? Wenn es ein Stellenangebot gibt, bekomme ich eine E-Mail oder muss ich regelmäßig auf der Seite/im Portal vorbeischauen? Was passiert, wenn ich die Übergabe annehme? Gehe ich direkt in die Luft, sobald ich die Übergabe annehme? Muss ich das Mikrofon nach der Übergabe ausschalten oder schaltet es sich automatisch aus? Ist es möglich, beide Mikrofone an meinem und dem meines Partners zu haben? Kann ich das Ein- und Ausschalten der Webcam während der Veranstaltung verwalten? Wenn ich das Bild meines Partners sehe, kann ich dann auch das des Sprechers sehen? Wenn ich die Webcam aktiviere, bin ich trotzdem nur für den Kollegen und nicht für die Teilnehmer sichtbar?`,
  interpreters_SecSubTitle: `Wen soll ich anschreiben, um mich für das Simulations-Webinar anzumelden?`,
  interpreters_SecSubTitlepara: `Sie müssen an hello.rafiky@gmail.com schreiben. Sie erhalten alle relevanten Informationen.`,
  interpreters_ThreeSubTitle: `Übersetzt die Rafiky-Anwendung Audio?`,
  interpreters_ThreeSubTitlepara: `Nein, die Rafiky-Anwendung streamt Audio. Der Dolmetscher (der vor Ort oder aus der Ferne arbeitet) kümmert sich um die Übersetzung.`,
  interpreters_FourSubTitle: `Welche Bandbreite wird benötigt?`,
  interpreters_FourSubTitlepara: `Benötigen Sie mindestens 4-6 Mbps Download / 4-6 Mbps Upload.`,
  interpreters_FiveSubTitle: `Wie funktioniert die Integration mit Microsoft Teams?`,
  interpreters_FiveSubTitlepara: `Referenten und Dolmetscher können über Rafiky teilnehmen, während alle anderen Teilnehmer direkt von Microsoft Teams aus die für die Veranstaltung verfügbaren Übersetzungssprachenkanäle aus den Optionen auswählen.`,
  interpreters_SixSubTitle: `Wenn es ein Stellenangebot gibt, bekomme ich eine E-Mail oder muss ich regelmäßig auf der Seite/im Portal vorbeischauen?`,
  interpreters_SixSubTitlepara: `Wir empfehlen Ihnen, sowohl unsere sozialen Netzwerke als auch unser Portal zu besuchen.`,
  interpreters_SevenSubTitle: `Was passiert, wenn ich die Übergabe annehme?`,
  interpreters_SevenSubTitlepara: `Wenn Sie die Übergabe akzeptieren, bedeutet dies, dass Ihr Partner einen Countdown gestartet hat, nach dem die Übersetzung an Sie übergeben wird.`,
  interpreters_EightSubTitle: `Gehe ich direkt in die Luft, sobald ich die Übergabe annehme?`,
  interpreters_EightSubTitlepara: `Nein, die ONAIR/OFFAIR-Mikrofonsteuerung ist absolut manuell. Es liegt im Ermessen und in der Verantwortung des Dolmetschers, das Mikrofon zu aktivieren oder zu deaktivieren. Gehen Sie auf Sendung und aktivieren Sie Ihr Mikrofon nur am Ende des Countdowns, der Ihren Partner gestartet hat (30 Sek. 3 Min. 5 Min.).`,
  interpreters_NineSubTitle: `Muss ich das Mikrofon nach der Übergabe ausschalten oder schaltet es sich automatisch aus?`,
  interpreters_NineSubTitlepara: `Ja, du musst das Mikrofon manuell ausschalten.`,
  interpreters_TenSubTitle: `Ist es möglich, beide Mikrofone an meinem und dem meines Partners zu haben?`,
  interpreters_TenSubTitlepara: `Ja, es ist möglich, beide Mikrofone eingeschaltet zu haben. Sollte dieser Modus verlängert werden, schaltet einer unserer Techniker eines der beiden Mikrofone ab.`,
  //Privacy Policy
  privacypolicy_Title: `Siehe unsere`,
  privacypolicy_SubTitle: `DATENSCHUTZ-BESTIMMUNGEN`,
  //Last Updated
  lastUpdated_Title: `Zuletzt aktualisiert [20,
        2020
    ] `,
  lastUpdated_para: `Wir respektieren die Privatsphäre unserer Benutzer und jeder Person, die unsere Websites www.rafiky.net besucht. Hier Rafiky Ltd . „Unternehmen“ „wir“ „uns“ oder „unser“ . Wir verpflichten uns, Ihre personenbezogenen Daten und Ihr Recht auf Privatsphäre gemäß der Datenschutz-Grundverordnung (DSGVO) zu schützen. Wenn Sie Fragen oder Bedenken zu unserer Richtlinie oder unseren Praktiken in Bezug auf Ihre personenbezogenen Daten haben, kontaktieren Sie uns bitte unter info@rafiky.net. Wenn Sie unsere Website www.rafiky.net „Website“ besuchen und unsere Dienste nutzen, vertrauen Sie uns Ihre personenbezogenen Daten an. Wir nehmen Ihre Privatsphäre sehr ernst. In dieser Datenschutzerklärung beschreiben wir unsere Datenschutzrichtlinie. Wir möchten Ihnen so klar wie möglich erklären, welche Informationen wir sammeln, wie wir sie verwenden und welche Rechte Sie in Bezug darauf haben. Wir hoffen, dass Sie sich etwas Zeit nehmen, um es sorgfältig durchzulesen, da es wichtig ist. Wenn diese Datenschutzrichtlinie Bestimmungen enthält, mit denen Sie nicht einverstanden sind, stellen Sie bitte die Nutzung unserer Website und unserer Dienste ein. Diese Datenschutzrichtlinie gilt für alle Informationen, die über unsere Website und/oder damit verbundene Dienstleistungen, Verkaufsmarketing oder Veranstaltungen gesammelt werden, die wir in dieser Datenschutzrichtlinie gemeinsam als „Website“ bezeichnen.`,
  //About Us
  aboutUs_Title: `ÜBER UNS`,
  aboutUs_Titlepara: `Rafiky ist eine flexibel skalierbare und erstklassige Cloud-Dolmetscherplattform für jede Art von Veranstaltung, Konferenzen oder Meetings. Durch die Plattform von Rafiky können Dolmetscher von überall aus arbeiten, sodass Veranstaltungsorganisatoren keine spezialisierten Hardware-Dolmetscherkabinen mieten und bereitstellen oder die Reise- und Unterbringungskosten der Dolmetscher bezahlen müssen. Veranstaltungsteilnehmer können Dolmetschen auf Konferenzebene genießen, indem sie die Sprache ihrer Wahl in kristallklarem Audio über die Rafiky-App oder über Funkkopfhörer hören. Unser Büro befindet sich in Großbritannien. Bitte lesen Sie diese Datenschutzrichtlinie sorgfältig durch, da sie Ihnen hilft, fundierte Entscheidungen über die Weitergabe Ihrer personenbezogenen Daten an uns zu treffen.`,
  aboutUs_FirstSubTitle: `WELCHE INFORMATIONEN ERHEBEN WIR?`,
  aboutUs_FirstSubTitlepara: `Personenbezogene Daten, die Sie uns offenlegen Wir erfassen personenbezogene Daten, die Sie uns freiwillig zur Verfügung stellen, wenn Sie Ihr Interesse bekunden, Informationen über uns oder unsere Produkte und Dienstleistungen zu erhalten, wenn Sie an Aktivitäten auf der Website teilnehmen oder uns anderweitig kontaktieren. Die personenbezogenen Daten, die wir erfassen, hängen vom Kontext Ihrer Interaktionen mit uns und der Website, den von Ihnen getroffenen Entscheidungen und den von Ihnen verwendeten Produkten und Funktionen ab. Die von uns erfassten personenbezogenen Daten können Folgendes umfassen: Name und Kontaktdaten. Wir erfassen Ihren Vor- und Nachnamen, E-Mail-Adresse, Postanschrift, Telefonnummer, E-Mail-Adresse und andere ähnliche Kontaktdaten. Referenzen. Wir sammeln Passwörter, Passworthinweise und ähnliche Sicherheitsinformationen, die für die Authentifizierung und den Kontozugriff verwendet werden. Zahlungsdatum. Wir erfassen Daten, die für die Verarbeitung Ihrer Zahlung erforderlich sind, wenn Sie Einkäufe tätigen, z. B. die Nummer Ihres Zahlungsinstruments, z. B. eine Kreditkartennummer, und den Sicherheitscode, der Ihrem Zahlungsinstrument zugeordnet ist. Alle Zahlungsdaten werden von unserem Zahlungsabwickler gespeichert und Sie sollten dessen Datenschutzrichtlinien lesen und sich direkt an den Zahlungsabwickler wenden, um Ihre Fragen zu beantworten. Standortinformationen: Wir verfolgen den Standort des Geräts, indem wir GPS-Koordinaten an unsere Anwendung senden. Wir können den Standort auch bestimmen, indem wir andere Daten von Ihrem Mobilgerät verwenden, wie z. B. Informationen zu drahtlosen Netzwerken oder Mobilfunkmasten in der Nähe Ihres Geräts. Wir verwenden und speichern Informationen über Ihren Standort, um viele Produkt- und Servicefunktionen zu ermöglichen, die von der Standortverfolgung abhängig sind. Wir können gesammelte Informationen auch verwenden, um Softwarefehler zu beheben, Datenanalysen durchzuführen, Testforschung zu betreiben und Nutzungs- und Aktivitätstrends zu überwachen und zu analysieren, um die Dienste zu verbessern und anzupassen. Automatisch erfasste Informationen Wir erfassen automatisch bestimmte Informationen, wenn Sie die Website besuchen, verwenden oder navigieren. Diese Informationen geben nicht Ihre spezifische Identität wie Ihren Namen oder Kontaktinformationen preis, sondern können Geräte- und Nutzungsinformationen wie Ihre IP-Adresse, Browser- und Geräteeigenschaften, Betriebssystem, Spracheinstellungen, verweisende URLs, Gerätename, Land, Standort, Informationen darüber, wie und wann Sie unsere Website nutzen, enthalten andere technische Informationen. Wenn Sie mit Ihrem Mobilgerät auf unsere Website zugreifen, erfassen wir möglicherweise automatisch Geräteinformationen wie Ihre Mobilgerät-ID, Modell- und Herstellerversionsinformationen und IP-Adresse. Diese Informationen werden in erster Linie benötigt, um die Sicherheit und den Betrieb unserer Website aufrechtzuerhalten und für unsere internen Analyse- und Berichtszwecke. Wie viele Unternehmen sammeln auch wir Informationen durch Cookies und ähnliche Technologien. Mehr dazu erfahren Sie in unserer Cookie-Richtlinie. Aus anderen Quellen gesammelte Informationen Wir können Informationen über Sie aus anderen Quellen wie öffentlichen Datenbanken, gemeinsamen Marketingpartnern, Social-Media-Plattformen wie Facebook sowie von anderen Dritten erhalten.`,
  aboutUs_SecSubTitle: `WIE VERWENDEN WIR IHRE INFORMATIONEN?`,
  ...
  aboutUs_FiveSubTitlepara: `Unser Server befindet sich in Nord-Virginia. Wir werden Ihre personenbezogenen Daten nicht an Empfänger im Ausland übermitteln.`,
  aboutUs_SixSubTitle: `WAS IST UNSERE HALTUNG ZU WEBSEITEN VON DRITTANBIETERN?`,
  ...
  aboutUs_TwelevSubTitlepara: `Wenn Sie Fragen oder Kommentare zu dieser Richtlinie haben, senden Sie uns eine E-Mail an info@rafiky.net`,
  //Get Started
  ...
  //Cookie Policy
  cookiePolicy_Title: `Siehe unsere`,
  cookiePolicy_SubTitle: `COOKIE-RICHTLINIE`,
  cookiePolicy_para: `INDEM SIE UNSERE WEBSITE UND DIENSTE WEITERHIN NUTZEN, STIMMEN SIE DER VERWENDUNG VON COOKIES UND ÄHNLICHEN TECHNOLOGIEN FÜR DIE ZWECKE ZU, DIE WIR IN DIESER COOKIE-RICHTLINIE BESCHREIBEN. WENN SIE DIE VERWENDUNG VON COOKIES UND ÄHNLICHEN TECHNOLOGIEN NICHT AKZEPTIEREN, VERWENDEN SIE DIESE WEBSITE NICHT. `,
  cookiePolicy_SecTitle: `Kekse`,
  cookiePolicy_SecTitlepara: `Ein Cookie ist eine kleine Textdatei, die eine Website auf Ihrem Computer oder Mobilgerät speichert, wenn Sie die Website besuchen. Im Allgemeinen haben Cookies zwei Hauptzwecke: Ihr Surferlebnis zu verbessern, indem sie sich an Ihre Aktionen und Präferenzen erinnern, und uns bei der Analyse unseres Website-Verkehrs zu helfen.`,
  cookiePolicy_ThirdTitle: `Was tun mit Cookies?`,
  cookiePolicy_ThirdTitlepara: `Wir verwenden Cookies, die uns helfen, den Datenverkehr auf der Website zu analysieren, um die Leistung und Benutzerfreundlichkeit der Website zu verbessern und die Website sicherer zu machen. Cookies von Drittanbietern helfen uns bei der Verwendung von Google Analytics, um Besuche auf der Website zu zählen und zu analysieren. Dies hilft uns zu verstehen, wie Menschen unsere Websites nutzen und wo wir Verbesserungen vornehmen müssen. Diese Drittanbieter-Cookies identifizieren Sie nicht spezifisch.`,
  //Types Category
  typesCategory_Title: `Arten und Kategorien der verwendeten Cookies`,
  typesCategory_para: `Listen Sie die Kategorien von Cookies auf, die verwendet werden in Zum Beispiel:`,
  typesCategory_FirstSubTitle: `eine Sicherheit`,
  typesCategory_FirstSubTitlepara: `Wir verwenden Cookies, um unsere Sicherheitsfunktionen zu aktivieren und zu unterstützen und uns dabei zu helfen, Verstöße gegen unsere Allgemeinen Geschäftsbedingungen durch böswillige Aktivitäten zu erkennen.`,
  typesCategory_SecSubTitle: `b) Leistungsanalytische Forschung und Werbung`,
  typesCategory_SecSubTitlepara: `Cookies helfen uns zu erfahren, wie gut unsere Website und unsere Webprodukte an verschiedenen Orten funktionieren. Wir verwenden diese auch, um Produktfunktionen und -dienste zu verbessern und zu recherchieren, auch wenn Sie von anderen Website-Anwendungen oder -Geräten wie Ihrem Arbeitscomputer oder Ihrem Mobilgerät aus auf diese Website zugreifen. Wir verwenden auch Cookies von Drittanbietern, um unsere Marketingbotschaften/Kommunikation mit Ihnen zu verbessern und zu personalisieren.`,
  typesCategory_ThirdSubTitle: `Cookies kontrollieren`,
  typesCategory_ThirdSubTitlepara: `Es steht Ihnen jederzeit frei, Cookies, die sich bereits auf Ihrem Computer befinden, über Ihre Browsereinstellungen zu löschen, und Sie können die meisten Browser so einstellen, dass sie verhindern, dass sie Ihrem Computer hinzugefügt werden. Dies kann Sie jedoch daran hindern, bestimmte Funktionen auf der Website zu nutzen.`,
  //Get Started
  getStarted_Title: `Lass uns anfangen `,
  getStarted_SubTitle: `Bereit für eine echte Veränderung? Lassen Sie uns dieses Ding zusammen bauen!`,
  getStarted_Btn: `FORDERN SIE EIN SCHNELLES ANGEBOT AN`,
  ...
  refundPolicy_header_heading: `STORNIERUNGS- UND RÜCKERSTATTUNGSRICHTLINIE`,
  refundPolicy_summary_firstHeading: `Umbuchungsgebühr`,
  refundPolicy_summary_firstPara: `Sie können die Bereitstellung der Dienste verschieben oder aussetzen, indem Sie uns benachrichtigen. Sie akzeptieren, dass wir Ihnen für jeden Teil der Dienstleistungen, die wir Ihnen vor der Umplanung oder Aussetzung der Dienstleistungen erbracht haben, zuzüglich einer Verwaltungsgebühr von 59,00 £ pro Arbeitstag während der Aussetzung der Dienstleistungen in Rechnung stellen können. Die Dienste dürfen von Ihnen nur für einen Zeitraum von maximal fünf (5) aufeinanderfolgenden Werktagen ausgesetzt werden, beginnend mit dem nächsten Werktag, der unmittelbar nach dem in der Bestellung angegebenen ursprünglichen Lieferdatum liegt.`,
  refundPolicy_summary_secPara: `Jede von uns zu Ihrer Bestellung hinzugefügte Verwaltungsgebühr ist Teil des Endpreises.    `,
  refundPolicy_summary_secHeading: `Stornierungsgebühren`,
  refundPolicy_summary_thirdPara: `Wenn Sie unseren Service kündigen möchten, dann:`,
  refundPolicy_summary_fourthPara: `· Für alle Dienstleistungen außer Dolmetschen, wenn Sie die Dienstleistungen stornieren, nachdem wir Ihre Bestellung angenommen haben, verpflichten Sie sich, uns 50 % des gesamten Bestellpreises spätestens am nächsten Werktag nach dem Datum der Stornierung Ihrer Bestellung zu zahlen, und Sie zahlen uns die Restbetrag der Bestellung spätestens zwei (2) Werktage nach dem Datum, an dem Sie die Bestellung storniert haben.`,
  refundPolicy_summary_fifthPara: `· Nur für Dolmetscherdienste Wir geben Ihnen im Angebot die Stornierungsgebühren an, die für den Fall gelten, dass Sie Ihre Bestellung bei uns stornieren. Durch die Annahme eines Angebots, das Dolmetscherdienste umfasst, stimmen Sie zu, an alle Stornierungsgebühren gebunden zu sein, die wir in diesem relevanten Angebot aufgeführt haben.`,
  refundPolicy_summary_thirdHeading: `WIDERRUFSRECHT`,
  refundPolicy_summary_sixthPara: `Wenn Sie den Vertrag aus einem unter (a) bis (e) unten aufgeführten Grund beenden/kündigen, endet der Vertrag sofort und wir erstatten Ihnen alle nicht oder nicht ordnungsgemäß erbrachten Dienstleistungen vollständig zurück. Die Gründe sind:`,
  refundPolicy_summary_seventhPara: `1. Wir haben Sie über eine bevorstehende Änderung der Dienste oder dieser Bedingungen informiert, mit der Sie nicht einverstanden sind; 2. Wir haben Sie über einen Fehler im Preis oder in der Beschreibung der von Ihnen bestellten Dienstleistungen informiert und Sie möchten nicht fortfahren; 3. Wir haben Ihnen mitgeteilt, dass wir beabsichtigen, unsere Rechte aus dem Vertrag an jemand anderen zu übertragen, und Sie nicht fortfahren möchten; 4. Es besteht das Risiko, dass die Bereitstellung der Dienste aufgrund von Ereignissen, die außerhalb unserer Kontrolle liegen, erheblich verzögert wird; oder 5. Wir haben die Bereitstellung der Dienste aus technischen Gründen ausgesetzt oder wir teilen Ihnen mit, dass wir sie aus technischen Gründen jeweils für einen Zeitraum von mehr als einem (1) Monat aussetzen werden.`,
  refundPolicy_summary_eigthPara: `Für die Stornierung können Sie uns unter unserer E-Mail-Adresse info@rafiky.net kontaktieren. Bei Stornierung erfolgt die Rückerstattung nur nach unserem alleinigen Ermessen.`,
  refundPolicy_summary_ninthPara: `Wir nehmen das Feedback der Benutzer sehr ernst und nutzen es, um unsere Produkte und die Servicequalität ständig zu verbessern.`,
  refundPolicy_summary_fourthHeading: `TEILSTORNIERUNG`,
  refundPolicy_summary_tenthPara: `· Teilstornierungen sind vorbehaltlich der Bestätigung durch unser Backoffice-Personal zulässig. Bei teilweiser Stornierung erfolgt eine teilweise Rückerstattung.`,
  refundPolicy_summary_fifthHeading: `UNNETHISCHE BESTELLUNG & STORNIERUNGSBEDINGUNGEN`,
  refundPolicy_summary_eleventhPara: `·Im Falle eines Kaufs, der auf unethische Weise getätigt wurde; durch Ausnutzen eines technischen Fehlers; oder durch Missbrauch/der Angebotsbedingungen/Richtlinien/Codes – www.rafiky.net wird/werden die jeweilige/n Bestellung/en storniert und wir sind in all diesen Fällen nicht verpflichtet, Ihnen eine Rückerstattung zu zahlen.`,
  refundPolicy_summary_sixthHeading: `RÜCKGABERECHT`,
  refundPolicy_summary_eleventhPara: `   Unsere Rückerstattungsrichtlinien sind einfach. Sie können eine Rückerstattung beantragen, indem Sie:`,
  refundPolicy_summary_tewelththPara: `1.Senden Sie uns eine E-Mail an info@rafiky.net oder;`,
  refundPolicy_summary_therteenthPara: `Wir unterstützen Sie gerne bei Problemen. Bei Fragen oder Problemen können Sie sich an unser Backoffice-Team wenden.`,
  refundPolicy_summary_forteenthPara: `Wenn aus irgendeinem Grund unser Backoffice-Personal die Rückerstattung bestätigt. Dann erfolgt die Erstattung entsprechend.`,
  refundPolicy_summary_fifteenthPara: `Hinweis: Wir behalten uns das Recht auf Änderungen der Rückerstattungsrichtlinie vor. Alle Änderungen werden auf unserer Website aktualisiert.`,
  refundPolicy_summary_seventhHeading: `Zahlungs- und Rückerstattungsmethoden`,
  ...
  faqData: [
    {
      ...
      para: "Zum ersten Mal in Italien wird auf unserer Plattform ein Konto erstellt, das vollständig von uns entwickelt wurde, sowohl für Kunden als auch für Dolmetscher. Anschließend kann der Kunde die Konferenz, an der er teilnehmen möchte, und die Zuhörersprache auswählen, und siehe da! Das Spiel ist fertig!",
    },
    {
      heading: "Für welche Sprachkombinationen?",
      para: "Wir übersetzen aus und in mehr als 200 Sprachen, dank unserer 6.000 Dolmetscher, die wir sorgfältig ausgewählt haben und weiterhin auswählen, um den besten Dolmetscherdienst in der Branche zu garantieren. Wir sind auch in mehr als 60 Ländern verfügbar, sowohl für was den öffentlichen Sektor betrifft, sowohl den privaten.",
    },
    {
      heading: "Wie hoch sind die Kosteneinsparungen mit Rafiky?",
      para: "Wir reduzieren die Dolmetschkosten um etwa 80 Prozent.",
    },
    {
      heading: "Welche Systeme dienen dem Datenschutz?",
      para: "Wir nutzen die sichersten Server auf dem Markt, was sehr wichtig ist, wenn es um Konferenzen geht, die einen gewissen Standard an Privatsphäre erfordern.",
    },
    {
      heading:
        "Ermöglicht die Plattform sowohl File-Sharing als auch Screen-Sharing während der Veranstaltung? Ist es auch möglich, einzelne Sitzungen aufzuzeichnen?",
      para: "Ja, die Plattform ermöglicht Ihnen sowohl die Bildschirmfreigabe als auch die Datei- und Präsentationsfreigabe. Anschließend ist es möglich, sowohl Video- als auch Audioaufzeichnungen im Original durchzuführen, und zwar in allen Sprachen, für die wir während der Konferenz gedolmetscht haben.“ . Sie erfordern zusätzliche Kosten, die wir natürlich in der Kostenvoranschlagsphase hinzufügen werden.",
    },
    {
      heading:
        "Stehen Ihnen rund um die Uhr Dolmetscher für Sonderwünsche zur Verfügung?",
      para: "Ohne Zweifel! Unsere Dolmetscher sind immer verfügbar.",
    },
    {
      heading:
        "Eine Veranstaltung hat mehrere Konferenzen in mehreren Räumen. Ist es möglich, Rafiky zu nutzen?",
      para: "Natürlich! Dies ist nur einer der Fälle, in denen es besonders teuer ist, Kabinen in verschiedenen Räumen zu nutzen. Bei Rafiky reicht es aus, in jedem Raum einen Computer mit Internetanschluss aufzustellen.",
    },
    {
      heading:
        "Wenn der Kunde seine eigenen Dolmetscher einsetzen möchte, bieten Sie dann eine spezielle Schulung an?",
      para: "Absolut ja und vor allem ohne zusätzliche Kosten!",
    },
    {
      heading:
        "Was ist, wenn es an dem Ort, an dem ich Rafiky nutzen möchte, keine Internetverbindung gibt?",
      para: "Wir arbeiten mit Unternehmen zusammen, die sich ebenfalls damit befassen, damit wir den Service überall problemlos gewährleisten können.",
    },
    {
      heading:
        "Was wäre, wenn die Veranstaltungsteilnehmer keine eigenen Kopfhörer hätten?",
      para: "In Absprache mit dem Veranstalter der Veranstaltung können wir Einweg-Ohrhörer, Kopfhörer und Powerbanks/Backup-Batterien zur Verfügung stellen, sodass jemand im Publikum diese bequem am Veranstaltungsort anfordern kann, wenn er sie benötigt.",
    },
    {
      heading: "Ist die Anzahl der Zugriffe auf die Plattform unbegrenzt?",
      para: "Die Anzahl der Anmeldungen ist je nach Abonnementpaket begrenzt.",
    },
    {
      heading:
        "Andererseits handelt es sich bei der technischen Unterstützung um eine kontinuierliche Überwachung oder sehen Sie eine andere Unterstützungsmodalität vor? Welche Rolle spielt der Techniker?",
      para: "Die Aufgabe unserer Techniker besteht darin, durch kontinuierliche Überwachung sicherzustellen, dass die Veranstaltung bestmöglich abläuft. Er erweist sich als echter Beobachter, sowohl in Bezug auf die Dolmetschung als auch in Bezug auf das im Raum anwesende Publikum.“ .",
    },
  ],
  terms_conditions: (
    <div
  ...
  faqApp: [
    {
      id: 1,
      btnHeading: "Darsteller",
      mainHeading: "Darsteller",
      subHeading: (
        <p>
          An wen muss ich schreiben, um mich für das Simulations-Webinar
          anzumelden?
          <p className="py-4">
            Erhalte ich nach diesem Webinar eine Rafiky-Zertifizierung?
          </p>
          <p>Übersetzt die Rafiky-App Audio? </p>
          <p className="py-4">Wie viel Bandbreite benötigen Sie? </p>
          <p>Wie funktioniert die Integration mit Microsoft Teams? </p>
          <p className="py-4">
            Wenn es ein Stellenangebot gibt, erhalte ich eine E-Mail oder ich
            muss nachsehen Besuchen Sie die Website/das Portal regelmäßig?
          </p>
          <p>Was passiert, wenn ich die Übergabe akzeptiere? </p>
          <p className="py-4">
            Gehe ich direkt in die Luft, sobald ich die Übergabe akzeptiere?
          </p>
          <p>
            Ich muss das Mikrofon nach der Übergabe ausschalten, sonst schaltet
            es sich ab automatisch von alleine?
          </p>
          <p className="py-4">
            Es ist möglich, beide Mikrofone eingeschaltet zu haben, meins und
            meins Partner?
          </p>
          <p>
            Kann ich das Ein- und Ausschalten der Webcam während der
            Veranstaltung verwalten?
          </p>
          <p className="py-4">
            Wenn ich das Bild meines {`Partners`} sehe, kann ich das auch noch
            sehen Berichterstatter?
          </p>
          <p>
            Wenn ich die Webcam aktiviere, bin ich nur für meinen Kollegen
            sichtbar und nicht an euch Teilnehmer?
          </p>
        </p>
      ),
      heading:
        "An wen muss ich schreiben, um mich für das Simulations-Webinar anzumelden?",
      para: (
        <p>
          – Sie müssen anschreiben
          ...
          <p className="pt-5 font-medium text-3xl">
            Übersetzt die Rafiky-Anwendung Audio?
          </p>
          <p className="py-5">
            Nein, die Rafiky-Anwendung streamt Audio. Zur Übersetzung der Ein
            Dolmetscher (der vor Ort oder aus der Ferne arbeitet) stellt zur
            Verfügung.
          </p>
          <p className="pt-5 font-medium text-3xl">
          ...
          <p className="py-4">
            Mindestens 4–6 Mbit/s Download/4–6 Mbit/s Upload erforderlich.{" "}
          </p>
          <p className="font-medium text-3xl pt-5">
            Wie funktioniert die Integration mit Microsoft Teams?
          </p>
          <p className="py-3">
            Redner und Dolmetscher können über Rafiky teilnehmen, während alle
            andere Teilnehmer direkt aus Microsoft Teams auswählen
            Übersetzungssprachenkanäle aus den für die verfügbaren Optionen
            Fall.
          </p>
          <p className="font-medium text-3xl pt-5">
            Wenn es ein Stellenangebot gibt, erhalte ich eine E-Mail oder ich
          ...
          <p className="py-4">
            Wir empfehlen Ihnen, sowohl unsere als auch unsere sozialen
            Netzwerke zu überprüfen Portal.{" "}
          </p>
          <p className="font-medium text-3xl pt-5">
            {" "}
            Was passiert, wenn ich die Übergabe annehme?
          </p>
          <p className="py-4">
            Wenn Sie die Übergabe akzeptieren, bedeutet dies, dass Ihr Partner
            eine hinterlassen hat Countdown, nach dem die Übersetzung an Sie
            weitergegeben wird.{" "}
          </p>
          <p className="font-medium text-3xl pt-5">
            Gehe ich direkt auf Sendung, sobald ich die Übergabe akzeptiere?
          </p>
          <p className="py-4">
            Nein, die Steuerung des ONAIR/OFFAIR-Mikrofons erfolgt vollständig
            manuell. Es ist Es liegt im Ermessen und in der Verantwortung des
            Dolmetschers, zu aktivieren oder Schalten Sie das Mikrofon stumm.
            Gehen Sie auf Sendung, indem Sie Ihr eigenes Gerät manuell
            aktivieren Mikrofon nur am Ende des Countdowns, der Ihren Partner
            gestartet hat (30 Sek., 3 Min., 5 Min.).
          </p>
          <p className="font-medium text-3xl pt-5">
            Ich muss das Mikrofon nach der Übergabe ausschalten, sonst schaltet
            es sich ab automatisch von alleine?
          ...
          <p className="py-4">
            Ja, Sie müssen das Mikrofon manuell ausschalten.
          </p>
          <p className="font-medium text-3xl pt-5">
            Es ist möglich, beide Mikrofone eingeschaltet zu haben, meins und
            meins Partner?
          ...
          <p className="py-4">
            Ja, es ist möglich, beide Mikrofone einzuschalten. Im Falle Dieser
            Modus sollte durch einen unserer Techniker erweitert werden eines
            der beiden Mikrofone ausschalten.
          </p>
        </p>
      ),
    },
    {
      ...
      subHeading: (
        <p>
          Videoanleitung für den Hörer: Android
          <p className="py-4">Videoanleitung für Hörer: iOS </p>
          <p>Wie viel Akkuleistung verbraucht die App? </p>
          <p className="py-4">
            Was passiert, wenn mich jemand anruft, während ich den Stream höre?
            Klang?
          </p>
          <p>
            Die App wird geschlossen, wenn ich währenddessen eine Nachricht
            sende oder im Internet surfe Audiostream hören?
          </p>
          <p className="py-4">
            Wenn ich die App öffne, steht dort „Keine geplanten
            Veranstaltungen“. Warum?
          </p>
          <p>Ist es möglich, Feedback von Teilnehmern zu sammeln? App?</p>
        </p>
      ),
      heading: "Videoanweisungen für Android-Listener",
      para: (
        <p>
          <a
          ...
          <p className="py-4">Videoanleitung für iOS-Listener </p>
          <p className="py-5">
            <a
              className="text-[#6CC1D7]"
              href={"https://www.youtube.com/watch?v=u6wyZwyTVoA"}
          ...
          <p className="pt-5 font-medium text-3xl">
            Wie viel Akkuleistung verbraucht die Rafiky-App?
          </p>
          <p className="py-5">
            Die App verbraucht etwa 4–8 % Ihres Akkus pro Stunde.
          </p>
          <p className="pt-5 font-medium text-3xl">
            Was passiert, wenn mich jemand anruft, während ich den Stream höre?
            Klang?
          ...
          <p className="py-4">
            Der Stream wird während des Anrufs pausiert (sogar WhatsApp, Viber
            usw.). Danach können Sie zur App zurückkehren und dort weitermachen,
            wo Sie aufgehört haben aus.
          </p>
          <p className="font-medium text-3xl pt-5">
            Die Rafiky-App wird geschlossen, wenn ich eine Nachricht sende oder
            im Internet surfe beim Anhören eines Audiostreams?
          </p>
          <p className="py-3">
            Nein, die Rafiky-App bleibt aktiv. Es lässt sich angenehm anhören
            die Veranstaltung mit anderen Anwendungen im Mobiltelefon.
          </p>
          <p className="font-medium text-3xl pt-5">
            Wenn ich die App öffne, steht dort „Keine geplanten
            Veranstaltungen“. Warum?
          ...
          <p className="py-4">
            Der Wortlaut „Keine geplanten Veranstaltungen“ erscheint, wenn:
          </p>
          <p>– Es gibt keine bevorstehenden Veranstaltungen</p>
          <p className="py-4">
            – Das Telefon ist mit einem anderen WLAN-Netzwerk verbunden als das
            Computer
          </p>
          <p>– Die Computer-App ist noch nicht geöffnet</p>
          <p className="py-4">– Keine Internetverbindung</p>
        </p>
      ),
    },
    ...
    {
      id: 3,
      btnHeading: "Teilnehmer",
      mainHeading: "Teilnehmer",
      subHeading: (
        <p>
          Wie kommen Teilnehmer mit Rafiky in Kontakt?
          <p className="py-4">
            Ich habe die Veranstaltung gestartet, aber die Lautstärke ist zu
            niedrig. Wie kann ich?
          </p>
          <p>
            Ich habe mich bei der Veranstaltung angemeldet, aber ich höre
            nichts. Wie kann ich lösen?
          </p>
          <p className="py-4">
            Mein Mikrofon und meine Webcam funktionieren nicht. Was muss ich
            tun?
          </p>
          <p>Wie gehe ich vor, wenn ich die Übersetzung nicht hören kann? </p>
          <p className="py-4">
            Ich möchte dem Berichterstatter eine Frage stellen. Wie kann ich
            eingreifen?
          </p>
          <p>
            Wie kann ich den technischen Support kontaktieren, während ich bei
            der Veranstaltung angemeldet bin?
          </p>
          <p className="py-4">
            Wie viele Sprachoptionen kann die App gleichzeitig unterstützen?
          </p>
          <p>Was kann ich tun, wenn ich technische Probleme habe? </p>
          <p className="py-4">
            Es ist ein Mindestabstand (zu den Lautsprechern) einzuhalten i
            Teilnehmer, die die Übersetzung von sich selbst hören möchten
            Geräte?
          </p>
          <p>
            Was passiert, wenn mich jemand anruft, während ich den Stream höre?
          ...
          <p className="py-4">
            Die App wird geschlossen, wenn ich währenddessen eine Nachricht
            sende oder im Internet surfe Ich höre Audio?
          </p>
          <p>Ist es möglich, Feedback von Teilnehmern zu sammeln? App?</p>
        </p>
      ),
      heading: "Wie kommen Teilnehmer mit Rafiky in Kontakt?",
      para: (
        <p>
          – elektronisch: per E-Mail an alle wenigen Teilnehmertage vor der
          Veranstaltung
          <p className="py-4">
            – Information der Teilnehmer über die Organisation der Veranstaltung
            (Rafiky-Plattform, Sprachen usw.) bei der Registrierung
          </p>
          <p className="py-5">
            Rafiky stellt sogar E-Mail-Vorlagen, PPT-Materialien und Flyer zur
            Verfügung alle Sprachen, um eine vollständige Kommunikation mit
            allen zu gewährleisten Teilnehmer.
          </p>
          <p className="pt-5 font-medium text-3xl">
            Ich habe die Veranstaltung gestartet, aber die Lautstärke ist zu
            niedrig. Wie kann ich?
          ...
          <p className="py-5">
            Bei geringer Lautstärke prüfen Sie bitte die Ausgangslautstärke der
            Teilnehmer Ausgabe von Computerperipheriegeräten. .
          </p>
          <p className="pt-5 font-medium text-3xl">
            Ich habe mich bei der Veranstaltung angemeldet, aber ich höre
            nichts. Wie kann ich lösen?
          ...
          <p className="py-4">
            Erhöhen Sie den Lautstärkeregler rechts neben dem Feld{" "}
            {`"Original"`}
            es herausziehen. Wenn das Problem weiterhin besteht, aktualisieren
            Sie bitte die Seite mit der Schaltfläche oben rechts.
          </p>
          <p className="font-medium text-3xl pt-5">
            Mein Mikrofon und meine Webcam funktionieren nicht. Wie kann ich?
          </p>
          <p className="py-3">
            Mithilfe der Ausrüstung können Sie Ihre eigenen Mikrofon- und
            Webcam-Geräte auswählen Schaltfläche in der oberen rechten Ecke.
          </p>
          <p className="font-medium text-3xl pt-5">
            Was mache ich, wenn ich die Übersetzung nicht hören kann?
          </p>
          <p className="py-4">
            Sie müssen die Übersetzung in die von Ihnen bevorzugte Sprache
            auswählen Dropdown-Menü, indem Sie auf die Schaltfläche{" "}
            {`"DOLMETSCHEN"`} klicken Spitze. Wir erinnern Sie auch daran, dass
            dies mit den Schiebereglern möglich ist entscheiden Sie sich, die
            Übersetzung und/oder die Originalsprache anzuhören.
          </p>
          <p className="font-medium text-3xl pt-5">
            Ich möchte dem Berichterstatter eine Frage stellen. Wie kann ich
            eingreifen?
          ...
          <p className="py-4">
            Wir erinnern alle netten Teilnehmer daran, dass Sie die eigene
            Kaution hinterlegen können Fragen, indem Sie den Redner im
            entsprechenden Abschnitt erwähnen, Wählen Sie „Chat“, klicken Sie
            auf „An“ und klicken Sie auf „Fragen &“. Antworten..
          </p>
          <p className="font-medium text-3xl pt-5">
            Wie kann ich den technischen Support kontaktieren, während ich bei
            der Veranstaltung angemeldet bin?
          ...
          <p className="py-4">
            Bei technischen Problemen wenden Sie sich bitte schriftlich an den
            Support-Techniker per Chat, wählen Sie „Chat“, drücken Sie auf „An“
            und wählen Sie dann „ den Abschnitt „Technischer Support“.
          </p>
          <p className="font-medium text-3xl pt-5">
            Was kann ich tun, wenn ich auf technische Probleme stoße?
          </p>
          <p className="py-4">
            {`Bei technischen Problemen empfehlen wir Ihnen, das zu aktualisieren
            Seite durch Drücken der vorletzten Taste rechts im oberen Bereich
            "Seite neu laden".`}
          </p>
          <p className="font-medium text-3xl pt-5">
            Es ist ein Mindestabstand (zu den Lautsprechern) einzuhalten i
            Teilnehmer, die die Übersetzung von sich selbst hören möchten Geräte
          </p>
          <p className="py-4">
            {`   Die Zuhörer können so weit von der Bühne entfernt sein, wie weit es WLAN gibt
            Verbindung. Sie können sich frei bewegen und ruhig auf den Parkplatz gehen
            Anhören der Übersetzung über WLAN oder über mobile Daten (3G / 4G).
            / LTE).`}
          </p>
        </p>
      ),
