export const en = {
  ...
  appointment_title: "Get to know us",
  aboutUsMetaTitle:
  ...
  appointment_salesDescription: "Every event stands out on its own. Set up a brief 15-minute chat with us to delve into your upcoming occasion and discover how we can craft a tailored solution and provide you with a quote that perfectly fits your specific requirements.",
  ...
  faqAppmetaDes: 'Rafiky App FAQ - Frequently Asked Questions About Rafiky',
  faqAppMetatitle: 'Every answer to your App questions about remote interpreting. Everything you need for your multilingual online event!',
  FAQMetaDescription:
  ...
  englishUKMetaDescription:
    "Rafiky is the best platform for British English interpreting! Discover our remote interpreting service in English!",
  englishUSMetaTitle:
  ...
  happyTeam: "Our team is happy to answer your requests. Fill out the form and we will contact you in 15 minutes!",
  ...
  FAQPerformer_pageDesc: "Are you a performer and want to discover the features available to you during an event? Discover Rafiky's dedicated FAQ section!",
  FAQPerformer_pagetitle: "Are you a performer and want to discover",
  ...
  // Footer INTEGRATION
  footer_section1Title: "Remote Interpretation",
  footer_section1: "Revolutionizing the world through remote simultaneous interpretation.",
  footer_section2Title: "Company",
  footer_section2: "Our team has more than 10 years of experience in event planning. We will take care of every detail",
  ...
  home_heroline: "Rafiky: The most advanced technology",
  card_heading2:
  ...
  captcha:
    "Copyright © 2023 Rafiky. All rights reserved",
  ...
  services_Card1Title: "INTEGRATION WITH MICROSOFT TEAMS",
  services_Card1para: "Planning an online conference on Microsoft Teams and need the assistance of language interpreters? Rafiky has the solution for you.",
  services_Card2Title: "SIGN LANGUAGE INTERPRETATION",
  services_Card2para: "Make your event even more accessible with Rafiky's exclusive Sign Language interpretation service!",
  services_Card3Title: "PROFESSIONAL REMOTE INTERPRETERS",
  services_Card3para: "Trust Rafiky's remote interpreters! The best professionals for all your needs.",
  //Teams Integration
  ...
  //The Advantages
  theAdvantages_Heading: "Rely on us",
  theAdvantages_para:
...
(If interpretation services are also required, a training session for interpreters will be provided as well)`,
 ...
 no matter where they are in the world, are capable of translating any type of message into the target language. Additionally, the live chat feature allows interpreters to have conversations during breaks and/or make specific requests during the event.`,
  ...
  //Services Advantages
  servicesAdvantages_Heading: "Rely on us",
  servicesAdvantages_para:
    "Rafiky manages the entire organization of the conference should this be required. Our team can take care of planning in every single detail from the pre-event phase to the post-event phase. This includes a series of services and offers such as the possibility of customizing the logo or the 'speaker girth' the creation of a website aimed solely at promoting or registering for the event or even the possibility of requesting more interpreters and multiple language combinations of translation. Rafiky boasts an unlimited network of multi-sector and native-speaking interpreters for more than 200 languages in total. A truly exclusive service is that of sign language interpreting essential in order to make your web conferencing even more accessible and inclusive.",
  servicesAdvantages_Btn: "THE REVOLUTION BEGINS",
  //Services Pronto
  ...
  ourSkills_SixthCardHeading: "Convenience",
  ourSkills_SixthCardDescription: `We optimize costs without compromising quality, offering economical and convenient solutions for your event or meeting.`,
...
Rafiky enables the utilization of remote simultaneous interpretation (RSI) simply through smartphones, tablets, or computers, in any language and in real-time, reducing costs and ensuring the excellence of a consistently high-quality service, just like traditional interpretation but without the cumbersome translation booths and the related setup and dismantling costs and time required.`,
  ...
  remoteSimultaneous_SubTitle: "INTERPRETERS CONNECTED REMOTELY",
  ...
  remoteSimultaneous_list1para: "Unrivaled Flexibility: Instant access to interpreters, any language, any event size, from anywhere, anytime.",
  remoteSimultaneous_list2para: "Experience seamless real-time video and audio interpretation with our platform, ensuring instant and effective communication.",
  remoteSimultaneous_list3para: "Our platform delivers flawless audio and video quality, ensuring clear and uninterrupted communication for seamless remote interpreting.",
  remoteSimultaneous_list4para: "Our platform offers a game-changing feature: Live Chat with Online Interpreters. Break down language barriers instantly",
  remoteSimultaneous_list5para: "Connect with on-site manager in real-time for personalized support and a seamless remote interpreting experience.",
  ...
  //Microsoft Teams
  microsoftTeams_Heading: "Remote interpretation for any type of event!",
  microsoftTeams_para: `To organize a successful conference, it is not always necessary to rely on technical equipment or the presence of professional interpreters on-site. Thanks to our revolutionary cloud-based simultaneous translation platform, we can connect users in real-time from anywhere in the world, eliminating the time and costs associated with technical equipment, transportation, and travel while ensuring the quality of professional interpreting services.`,
  ...
  talkToSalesPara: "Every event stands out on its own. Set up a brief 15-minute chat with us to delve into your upcoming occasion and discover how we can craft a tailored solution and provide you with a quote that perfectly fits your specific requirements.",

  // UNLOCK

  fndOut: "FIND OUT HOW",
  inPersonHeading: "IN-PERSON AND HYBRID EVENTS",
  inPersonPara: "Discover a new era in hardware connectivity with our cutting-edge cloud-based interpreting solution. Transform your events into unforgettable experiences.",
  virtualMeetingsHeading: "VIRTUAL EVENTS",
  virtualMeetingsPara: "Customize Rafiky to create your multilingual conference hall and accommodate thousands of participants. Make your virtual events unique.",
  onlineMeetingsHeading: "ONLINE MEETINGS",
  onlineMeetingsPara: "Conduct seamless multilingual online meetings with Rafiky and effortlessly overcome language barriers.",
